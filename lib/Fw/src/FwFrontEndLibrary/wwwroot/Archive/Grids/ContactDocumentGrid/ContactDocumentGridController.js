//----------------------------------------------------------------------------------------------
var ContactDocumentGridController = {
    Module: 'ContactDocumentGrid'
};
//----------------------------------------------------------------------------------------------
ContactDocumentGridController.init = function($control) {
};
//----------------------------------------------------------------------------------------------
ContactDocumentGridController.addGridSubMenu = function($control, $menu) {
