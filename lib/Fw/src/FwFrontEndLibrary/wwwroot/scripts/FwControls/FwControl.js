...
FwControl.getHtmlTag = function($this) {
    ...
    if ((typeof designerObj !== 'object') || (typeof designerObj[functionName] !== 'function')) throw 'Not implemented: ' + data_control + '.' + functionName;
...
FwControl.loadControls = function($these) {
    ...
    $these.each(function(index, element) {
        ...
        if ((typeof controlObj === 'object') && (typeof controlObj[functionName] === 'function')) {
