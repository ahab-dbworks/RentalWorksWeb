...
FwValidation.init = function($control) {
    ...
    $validationbrowse.data('ondatabind', function (request) {
        ...
        if ($validationbrowse.attr('data-apiurl') === 'undefined') {
    ...
    $btnhelp
        .on('click', function () {
            ...
            if (popupModuleId !== '') {
                ...
                jQuery(document).find('.fwpopup').one('click', function () {
