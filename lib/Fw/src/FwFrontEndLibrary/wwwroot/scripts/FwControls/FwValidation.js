    ...
    $btnpeek
        .on('click', function () {
            ...
            if (popupModuleId !== '') {
                ...
                if (popupModule === 'FacilityCategory' || popupModule === 'PartsCategory' || popupModule === 'RentalCategory' || popupModule === 'SalesCategory' || popupModule === 'LaborCategory' || popupModule === 'MiscCategory') {
                    $popupForm.find('div.fwformfield[data-datafield="CategoryId"] input').val(popupModuleId);
                } else {
