...
var FwGridMenu = {};
//---------------------------------------------------------------------------------
FwGridMenu.upgrade = function($control) {
...
//---------------------------------------------------------------------------------
FwGridMenu.init = function($control) {
    FwGridMenu.upgrade($control);

};
//---------------------------------------------------------------------------------
FwGridMenu.getDesignerProperties = function(data_type) {
...
//---------------------------------------------------------------------------------
FwGridMenu.renderDesignerHtml = function($control) {
...
//---------------------------------------------------------------------------------
FwGridMenu.renderRuntimeHtml = function($control) {
    var html, $usercontrolChildren;

    $control.attr('data-rendermode', 'runtime');
};
//---------------------------------------------------------------------------------
FwGridMenu.renderTemplateHtml = function($control) {
    var data_type, data_rendermode, html;
    data_type = $control.attr('data-type');
    data_rendermode = $control.attr('data-rendermode');
...
//---------------------------------------------------------------------------------
FwGridMenu.getMenuControl = function(controltype) {
    var html, $menuObject;
...
//---------------------------------------------------------------------------------
FwGridMenu.addSubMenu = function($control) {
    var $btn, html;
...
//---------------------------------------------------------------------------------
FwGridMenu.addSubMenuColumn = function($control) {
    var html, $column;
...
//---------------------------------------------------------------------------------
FwGridMenu.addSubMenuGroup = function($control, groupcaption, securityid) {
    var html, $group;
...
//---------------------------------------------------------------------------------
FwGridMenu.addSubMenuBtn = function($group, caption, securityid) {
    var html, $btn;
...
//---------------------------------------------------------------------------------
FwGridMenu.addCaption = function($control, caption) {
    var $caption, html;
...
//---------------------------------------------------------------------------------
FwGridMenu.addStandardBtn = function($control, caption, securityid) {
...
//---------------------------------------------------------------------------------
FwGridMenu.addViewBtn = function($control, caption, subitems) {
...
//---------------------------------------------------------------------------------
FwGridMenu.generateDropDownViewBtn = function(caption, active) {
    var btnHtml, $ddBtn;
    btnHtml = [];
...
//---------------------------------------------------------------------------------
FwGridMenu.addVerticleSeparator = function($control) {
    var html, $vr;
    html = [];
...
//---------------------------------------------------------------------------------
FwGridMenu.addCustomContent = function($control, $content) {
