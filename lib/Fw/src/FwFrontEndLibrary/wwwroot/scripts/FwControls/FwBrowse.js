        ...
        for (rowIndex = 0; rowIndex < dt.Rows.length; rowIndex++) {
            ...
            for (columnIndex = 0; columnIndex < columns.length; columnIndex++) {
                ...
                for (var fieldIndex = 0; fieldIndex < scrollerCol.fields.length; fieldIndex++) {
                    ...
                    if ((typeof field.cellcolor !== 'undefined') && (field.cellcolor.length > 0)) {
                        var color, colorColumnIndex;
                        if (typeof dt.ColumnIndex[field.cellcolor] !== 'number') {
                            throw 'FwBrowse.databindcallback: browsecellbackgroundcolorfield: "column ' + field.cellcolor + '" was not returned by the web service.';
                        }
                        color = dtRow[dt.ColumnIndex[field.cellcolor]];
                        
                        $td.css("position", "relative");
                        document.documentElement.style.setProperty("--cellColor", color);
