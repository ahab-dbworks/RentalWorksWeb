FwFormField_orderby = {};
//---------------------------------------------------------------------------------
FwFormField_orderby.renderDesignerHtml = function($control, html) {
    
};
//---------------------------------------------------------------------------------
FwFormField_orderby.renderRuntimeHtml = function($control, html) {
...
//---------------------------------------------------------------------------------
FwFormField_orderby.loadItems = function($control, items, hideEmptyItem) {
...
//---------------------------------------------------------------------------------
FwFormField_orderby.loadForm = function($fwformfield, table, field, value, text) {
    
};
//---------------------------------------------------------------------------------
FwFormField_orderby.disable = function($control) {

};
//---------------------------------------------------------------------------------
FwFormField_orderby.enable = function($control) {

};
//---------------------------------------------------------------------------------
FwFormField_orderby.getValue2 = function($fwformfield) {
    var value = [];
...
//---------------------------------------------------------------------------------
FwFormField_orderby.setValue = function($fwformfield, value, text, firechangeevent) {
