FwFormField_select = {};
//---------------------------------------------------------------------------------
FwFormField_select.renderDesignerHtml = function ($control, html) {
...
//---------------------------------------------------------------------------------
FwFormField_select.renderRuntimeHtml = function ($control, html) {
    html.push('<div class="fwformfield-caption">' + $control.attr('data-caption') + '</div>');
    html.push('<div class="fwformfield-control">');
    html.push('<select class="fwformfield-value"');
    if ($control.attr('data-enabled') === 'false') {
...
//---------------------------------------------------------------------------------
FwFormField_select.loadItems = function ($control, items, hideEmptyItem) {
...
//---------------------------------------------------------------------------------
FwFormField_select.loadForm = function ($fwformfield, table, field, value, text) {
...
//---------------------------------------------------------------------------------
FwFormField_select.disable = function ($control) {

};
//---------------------------------------------------------------------------------
FwFormField_select.enable = function ($control) {

};
//---------------------------------------------------------------------------------
FwFormField_select.getValue2 = function ($fwformfield) {
    var value = $fwformfield.find('.fwformfield-value').val();
    return value;
};
//---------------------------------------------------------------------------------
FwFormField_select.setValue = function ($fwformfield, value, text, firechangeevent) {
