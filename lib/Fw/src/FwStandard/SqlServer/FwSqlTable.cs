...
namespace FwStandard.SqlServer
{
    public class FwSqlTable
    {
        ...
        //---------------------------------------------------------------------------------------------
        //public FwSqlColumnCollection Columns {get;private set;}
        ...
        public FwSqlCommand GetInsertCommand(FwSqlConnection conn)
        {
            ...
            if (SaveData)
            {
                ...
                //foreach(var uniqueIdItem in this.UniqueIds)
                //{
                //    if (!uniqueIdItem.Value.ColumnSchema.IsIdentity)
                //    {
                //        qry.Add(prefix + uniqueIdItem.Value.Column);
                //        prefix = ",";
                //    }
                //}
                foreach(var fieldItem in this.Fields)
                ...
                //    {
                //        qry.Add(prefix + "@" + uniqueIdItem.Value.Column);
                //        qry.AddParameter("@" + uniqueIdItem.Value.Column, uniqueIdItem.Value.SQLFormat());
                //        prefix = ",";
                //    }
                //}
                foreach(var fieldItem in this.Fields)
        ...
        public FwSqlCommand GetUpdateCommand(FwSqlConnection conn)
        {
            ...
            if (SaveData)
            {
                ...
                foreach(var fieldItem in this.Fields)
                {
                    ...
                    //if ((!column.UniqueIdentifier) && (!column.ColumnSchema.IsIdentity) && (column.Modified))
        ...
        //---------------------------------------------------------------------------------------------
        //public static FwSQLColumn GetData(string tableName, string tableId, string tableIdValue, string column)
        //{
        //    string value = string.Empty;
        //    FwSQLTable table = new FwSQLTable(tableName);
        //    table.GetColumn(tableId).UniqueIdentifier = true;
        //    table.GetColumn(tableId).Value = tableIdValue;
        //    table.GetColumn(column);
        //    table.SelectRow();
        //    return table.GetColumn(column);
        //}
        //---------------------------------------------------------------------------------------------
        //public static FwSqlTableRow GetDataRow(string tableName, string uniqueId, string uniqueIdValue)
        //{
        //    return FwSqlTable.GetDataRow(tableName, new string[]{uniqueId}, new string[]{uniqueIdValue});
        //}
        //---------------------------------------------------------------------------------------------
        //public static FwSqlTableRow GetDataRow(string tableName, string[] uniqueIds, string[] uniqueIdValues)
        //{
        //    Dictionary<string, string> ids = new Dictionary<string,string>();
        //    for (int i = 0; i < uniqueIds.Length; i++)
        //    {
        //        ids[uniqueIds[i]] = uniqueIdValues[i];
        //    }
        //    return FwSqlTable.GetDataFields(tableName, ids);
        //}
        //---------------------------------------------------------------------------------------------
        //public static FwSqlTableRow GetDataFields(string tableName, Dictionary<string,string> ids)
        //{
        //    FwSqlTableRow dataFields = new FwSqlTableRow();
        //    FwSqlTable table = new FwSqlTable(tableName);
        //    //List<FwSQLColumnSchema> columnSchemaCollection = FwApplication.Current.GetSQLTableSchema(tableName).Columns;
            
        //    //foreach (FwSQLColumnSchema columnSchema in columnSchemaCollection)
        //    //{
        //    //    FwSQLColumn column = table.GetColumn(columnSchema.Column);
        //    //    foreach (string uniqueIdentifier in ids.Keys)
        //    //    {
        //    //        if (column.Column == uniqueIdentifier)
        //    //        {
        //    //            column.UniqueIdentifier = true;
        //    //            column.Value = ids[uniqueIdentifier];
        //    //            break;
        //    //        }
        //    //    }
        //    //}
        //    //table.SelectRow();
        //    //foreach (FwSQLColumn column in table.Columns)
        //    //{
        //    //    dataFields.Add(column.Column, new FwDatabaseField(column.Value));
        //    //}
        //    return dataFields;
        //}
        //---------------------------------------------------------------------------------------------
        //public static FwSqlTableRow xGetDataFields(string tableName, string uniqueIdentifier, string value)
        //{
        //    Dictionary<string, string> ids;
        //    FwSqlTableRow sqlTableRow;
            
        //    ids = new Dictionary<string, string>();
        //    ids.Add(uniqueIdentifier, value);
        //    sqlTableRow = GetDataFields(tableName, ids);
        ...
        private bool CheckDuplicate(string sql)
        {
            ...
            //    //qry.Add(sql);
            //    //qry.Execute();
            //    //count = qry.GetField("totalcount").ToInt32();
            //    //isdupe = (count > 0);
            //}
            return isdupe;
        }
