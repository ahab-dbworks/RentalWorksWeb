...
namespace FwCore.Middleware
{
    class FwMaintainCorsHeaders
    {
        private readonly RequestDelegate _next;

        public FwMaintainCorsHeaders(RequestDelegate next)
        {
            _next = next;
        }
    ...
    {
        public static IApplicationBuilder FwMaintainCorsHeaders(this IApplicationBuilder builder)
        {
            return builder.UseMiddleware<FwMaintainCorsHeaders>();
        }
    }
}
