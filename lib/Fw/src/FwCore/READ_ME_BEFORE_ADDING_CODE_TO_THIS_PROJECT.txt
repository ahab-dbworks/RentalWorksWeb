FwCore is reserved for .NET Core implementation specific files such as Controllers and Security Providers.  
...
then any files that can compile in FwStandard need to be in FwStandard.  The reason for this is that FwStandard targets .NET Standard 
