            ...
            if (context.ActionDescriptor is ControllerActionDescriptor)
            {
                ...
                else
                {
                    ...
                    if (controllerMethodAttribute.ValidateSecurityGroup)
                    {
                        ...
                        // hack to allow validations to work without configuring security
                        // this causes the validation filter to ignore security settings on any method named BrowseAsync
                        //if (groupTreeNode.Caption == "BrowseAsync")
                        //{
                        //    return Task.CompletedTask;
                        //}
