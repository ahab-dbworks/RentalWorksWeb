...
namespace FwStandard.Security
{
    ...
    public class FwSecurityTree
    {
        ...
        //---------------------------------------------------------------------------------------------
        public FwSecurityTree(DatabaseConfig dbConfig)
        {
            _dbConfig = dbConfig;
        }
        //---------------------------------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------------------------------
        public FwSecurityTreeNode GetGroupsTree(string groupsid, bool removeHiddenNodes)
        {
            ...
            jsonApplicationTree = JsonConvert.SerializeObject(FwSecurityTree.Tree.System);
            groupTree           = JsonConvert.DeserializeObject<FwSecurityTreeNode>(jsonApplicationTree);
            ...
            FwSqlCommand qry = new FwSqlCommand(FwSqlConnection.AppConnection);
