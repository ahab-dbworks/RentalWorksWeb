...
{
    class ContactCompanyGrid : FwGrid
    {
        //---------------------------------------------------------------------------------------------
        protected override void setBrowseQry(FwSqlSelect selectQry)
        {
            ...
            FwValidate.TestPropertyDefined("ContactCompany.SetBrowseQry", request, "miscfields");
        ...
        protected override void beforeInsert()
        {
            ...
            FwValidate.TestPropertyDefined("ContactCompany.BeforeInsert", request, "miscfields");
            base.beforeInsert();
            miscfields     = request.miscfields;
            fieldContactId = miscfields["contact.contactid"];
