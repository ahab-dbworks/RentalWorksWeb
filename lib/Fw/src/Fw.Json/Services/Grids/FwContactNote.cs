...
namespace Fw.Json.Services.Grids
{
    class FwContactNote : FwGrid
    {
        ...
        protected override void setBrowseQry(FwSqlSelect selectQry)
        {
            ...
            FwValidate.TestPropertyDefined("FwContactNote.SetBrowseQry", request, "miscfields");
        ...
        protected override void beforeInsert()
        {
            ...
            FwValidate.TestPropertyDefined("FwContactNote.BeforeInsert", request, "miscfields");
            base.beforeInsert();
            miscfields     = request.miscfields;
            fieldContactId = miscfields["contact.contactid"];
