...
namespace Fw.Json.SqlServer
{
    ...
    public class FwSqlCommand : IDisposable
    {
        ...
        //------------------------------------------------------------------------------------
        public FwSqlCommand(FwSqlConnection conn)
        {
        ...
        //------------------------------------------------------------------------------------
        public FwSqlCommand(FwSqlConnection conn, FwQueryTimeouts queryTimeoutType) : this(conn)
        {
            switch(queryTimeoutType)
            {
                case FwQueryTimeouts.Default:
                    this.sqlCommand.CommandTimeout = FwConvert.ToInt32(FwApplicationConfig.CurrentSite.DatabaseConnectionFinder[conn.DatabaseConnection].QueryTimeout);
                    break;
                case FwQueryTimeouts.Report:
                    this.sqlCommand.CommandTimeout = FwConvert.ToInt32(FwApplicationConfig.CurrentSite.DatabaseConnectionFinder[conn.DatabaseConnection].ReportQueryTimeout);
                    break;
            }
        }
        //------------------------------------------------------------------------------------
        public FwSqlCommand(FwSqlConnection conn, string storedProcedureName)
        {
            this.sqlConnection = conn;
            this.sqlCommand = new SqlCommand();
            this.sqlCommand.Connection = this.sqlConnection.GetConnection();
        ...
        //------------------------------------------------------------------------------------
        public FwSqlCommand(FwSqlConnection conn, string storedProcedureName, FwQueryTimeouts queryTimeoutType) : this(conn, storedProcedureName)
        {
            switch(queryTimeoutType)
            {
                case FwQueryTimeouts.Default:
        ...
        //------------------------------------------------------------------------------------
        public static FwDatabaseField GetData(FwSqlConnection conn, string tablename, string wherecolumn, string wherecolumnvalue, string selectcolumn)
        {
            FwSqlCommand qry;
        ...
        //------------------------------------------------------------------------------------
        public static string GetStringData(FwSqlConnection conn, string tablename, string wherecolumn, string wherecolumnvalue, string selectcolumn)
        {
            FwDatabaseField field;
            string result=string.Empty;

            field  = FwSqlCommand.GetData(conn, tablename, wherecolumn, wherecolumnvalue, selectcolumn);
            result = (field != null) ? field.ToString().TrimEnd() : string.Empty;
            
            return result;
        }
        //------------------------------------------------------------------------------------
        public static bool GetBoolData(FwSqlConnection conn, string tablename, string wherecolumn, string wherecolumnvalue, string selectcolumn)
        {
            FwDatabaseField field;
            bool result;
        ...
        //------------------------------------------------------------------------------------
        public static Dictionary<string, FwDatabaseField> GetRow(FwSqlConnection conn, string tablename, string wherecolumn, string wherecolumnvalue, bool throwExceptionIfRowCountNot1)
        {
            FwSqlCommand qry;
        ...
        //------------------------------------------------------------------------------------
        public static int SetData(FwSqlConnection conn, string table, string wherecolumn, string wherecolumnvalue, string updatecolumn, string updatecolumnvalue)
        {
            FwSqlCommand cmd;

            cmd = new FwSqlCommand(conn);
