...
FwServices.grid.method = function(request, module, method, $elementToBlock, onSuccess, onError) {
    ...
    if (typeof controller.apiurl !== 'undefined') {
        if (method === 'Load') {
            ...
            FwAppData.apiMethod(true, 'POST', controller.apiurl + '/saveform', request, FwServices.defaultTimeout, onSuccess, onError, $elementToBlock);
        }
...
//----------------------------------------------------------------------------------------------
FwServices.validation.method = function(request, module, method, $elementToBlock, onSuccess, onError) {
    var controller = window[module + 'Controller'];
    if (typeof controller === 'undefined') {
        throw module + 'Controller is not defined.'
    }
