...
FwBasePages.getLoginScreen = function(viewModel) {
    ...
    html.push('      <div class="login-field">');
    ...
    html.push('      <div class="login-button btnLogin">{{captionBtnLogin}}</div>');
...
FwBasePages.getMobileLoginScreen = function(viewModel) {
    ...
    html.push('      <div class="mobilelogin-email">');
    ...
    html.push('      </div>');
    html.push('      <div class="mobilelogin-password">');
    ...
    html.push('      <div id="mobilelogin-btnLogin">{{captionBtnLogin}}</div>');
    html.push('    </div>');
