...
var FwMenu = {};
//---------------------------------------------------------------------------------
FwMenu.upgrade = function($control) {
...
//---------------------------------------------------------------------------------
FwMenu.init = function($control) {
    FwMenu.upgrade($control);

};
//---------------------------------------------------------------------------------
FwMenu.getDesignerProperties = function(data_type) {
...
//---------------------------------------------------------------------------------
FwMenu.renderDesignerHtml = function($control) {
...
//---------------------------------------------------------------------------------
FwMenu.renderRuntimeHtml = function($control) {
    var html, $usercontrolChildren;

    $control.attr('data-rendermode', 'runtime');
};
//---------------------------------------------------------------------------------
FwMenu.renderTemplateHtml = function($control) {
    var data_type, data_rendermode, html;
    data_type = $control.attr('data-type');
    data_rendermode = $control.attr('data-rendermode');
...
//---------------------------------------------------------------------------------
FwMenu.getMenuControl = function(controltype) {
    var html, $menuObject;
...
//---------------------------------------------------------------------------------
FwMenu.addSubMenu = function($control) {
    var $btn, html;

    html = [];
    html.push('<div class="submenubutton">');
        html.push('<div class="icon"><i class="material-icons">menu</i></div>');
...
//---------------------------------------------------------------------------------
FwMenu.addSubMenuColumn = function($control) {
    var html, $column;
...
//---------------------------------------------------------------------------------
FwMenu.addSubMenuGroup = function($control, groupcaption, securityid) {
    var html, $group;
...
//---------------------------------------------------------------------------------
FwMenu.addSubMenuBtn = function($group, caption, securityid) {
    var html, $btn;
...
//---------------------------------------------------------------------------------
FwMenu.addStandardBtn = function($control, caption, securityid) {
    ...
    if ((caption !== '') && (typeof caption !== 'undefined')) {
        try {
            ...
            if ($control.hasClass('default')) {
                switch (caption) {
                    case 'New':    btnHtml.push('<i class="material-icons">add</i>');       break;
                    case 'Edit':   btnHtml.push('<i class="material-icons">mode_edit</i>'); break;
                    case 'Delete': btnHtml.push('<i class="material-icons">delete</i>');    break;
                    case 'Save':   btnHtml.push('<i class="material-icons">save</i>');      break;
                }
            }
...
//---------------------------------------------------------------------------------
FwMenu.addViewBtn = function($control, caption, subitems) {
    ...
    btnHtml.push('    <i class="material-icons">arrow_drop_down</i>');
...
//---------------------------------------------------------------------------------
FwMenu.generateDropDownViewBtn = function(caption, active) {
    var btnHtml, $ddBtn;
    btnHtml = [];
...
//---------------------------------------------------------------------------------
FwMenu.addVerticleSeparator = function($control) {
    var html, $vr;
    html = [];
