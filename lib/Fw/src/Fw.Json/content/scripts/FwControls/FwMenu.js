    ...
    if ((caption !== '') && (typeof caption !== 'undefined')) {
        try {
            ...
            if ($control.hasClass('default')) {
                switch (caption) {
                    case 'New':    btnHtml.push('<i class="material-icons">&#xE145;</i>'); break;
                    case 'Edit':   btnHtml.push('<i class="material-icons">&#xE254;</i>'); break;
                    case 'Delete': btnHtml.push('<i class="material-icons">&#xE872;</i>'); break;
                    case 'Save':   btnHtml.push('<i class="material-icons">&#xE161;</i>'); break;
                }
            }
