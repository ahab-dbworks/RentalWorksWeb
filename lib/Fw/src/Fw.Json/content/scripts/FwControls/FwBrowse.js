            ...
            if (gridMenuBar !== null) {
                if (gridMenuBar.properties.visible === 'T') {
                    ...
                    if ($submenubtn !== null) {
                        ...
                        var $rowactions = FwMenu.addSubMenuGroup($submenucolumn, 'Actions', '');
                        if (nodeDeleteAction !== null && nodeDeleteAction.properties['visible'] === 'T') {
                            var $submenuitem = FwMenu.addSubMenuBtn($rowactions, 'Delete Selected', nodeDeleteAction.id);
                    ...
                    FwMenu.addCaption($menu, $control.attr('data-caption'));
    ...
    try {
        ...
        for (rowIndex = 0; rowIndex < dt.Rows.length; rowIndex++) {
            ...
            for (columnIndex = 0; columnIndex < columns.length; columnIndex++) {
                ...
                $td = jQuery('<td class="column tdfield">');
                $td.css({
                ...
                if ($control.attr('data-type') === 'Grid') {
                    ...
                    if (columnIndex === columns.length - 1) {
                        ...
                        $td.find('.browsecontextmenu').on('click', function () {
                            try {
                                var menuItemCount = 0;
                                ...
                                if (menuItemCount === 0) {
                                    FwContextMenu.destroy($browsecontextmenu);
                                }
                            } catch (ex) {
                                FwFunc.showError(ex);
                            }
...
FwBrowse.addSaveAndCancelButtonToRow = function ($control, $tr) {
    // add the save button
    var $tdselectrow = $tr.find('.tdselectrow');
    $tdselectrow.find('.divselectrow').hide();
    ...
    $tdselectrow.append($divsaverow); 

    // add the cancel button
    var $browsecontextmenucell = $tr.find('.browsecontextmenucell');
    $browsecontextmenucell.find('.browsecontextmenu').hide();
    ...
    $browsecontextmenucell.append($divcancelsaverow); 
};
//---------------------------------------------------------------------------------
