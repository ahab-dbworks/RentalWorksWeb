...
FwAppImage.renderRuntimeHtml = function($control) {
    ...
    if ($control.attr('data-hasadd') !== 'false') {
        html.push('    <div class="button btnAdd"><i class="material-icons">&#xE145;</i><span class="caption">Add</span></div>');
    }
    html.push('    <div class="button btnRefresh"><i class="material-icons">&#xE5D5;</i><span class="caption">Refresh</span></div>');
    html.push('  </div>');
