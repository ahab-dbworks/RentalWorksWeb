//---------------------------------------------------------------------------------
FwAppImage = {};
FwAppImage.blankDataUrl = 'data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==';
//---------------------------------------------------------------------------------
FwAppImage.init = function($control) {
    ...
    $control
        .on('click', '.btnAdd', function(event) {
            ...
            try {
                ...
                var iscordova = (typeof navigator.camera === 'object') && (typeof navigator.camera.getPicture === 'function');
                if (iscordova) {
                ...
                html = html.join('\n');
                $confirmation = FwConfirmation.renderConfirmation('Upload Image', html);
...
//---------------------------------------------------------------------------------
FwAppImage.getHtmlTag = function(data_type) {
...
//---------------------------------------------------------------------------------
FwAppImage.getDesignerProperties = function(data_type) {
...
//---------------------------------------------------------------------------------
FwAppImage.renderDesignerHtml = function($control) {
...
//---------------------------------------------------------------------------------
FwAppImage.renderRuntimeHtml = function($control) {
    ...
    if ($control.attr('data-hasadd') !== 'false') {
        html.push('    <div class="button btnAdd"><i class="material-icons">add</i><span class="caption">Add</span></div>');
    }
    html.push('    <div class="button btnRefresh"><i class="material-icons">refresh</i><span class="caption">Refresh</span></div>');
    html.push('  </div>');
...
//---------------------------------------------------------------------------------
FwAppImage.getImageHtml = function($control, mode, image) {
...
//---------------------------------------------------------------------------------
FwAppImage.getAddImageHtml = function($control) {
    var html, imageHtml;
...
//---------------------------------------------------------------------------------
FwAppImage.renderTemplateHtml = function($control) {
...
//---------------------------------------------------------------------------------
FwAppImage.loadControl = function($control) {
    var $form, response;
...
//---------------------------------------------------------------------------------
FwAppImage.pasteImage = function($control, element, event) {
...
//---------------------------------------------------------------------------------
FwAppImage.dragoverImage = function($control, element, event) {
    var dataTransfer;
...
//---------------------------------------------------------------------------------
FwAppImage.dropImage = function($control, element, event) {
...
//---------------------------------------------------------------------------------
FwAppImage.fileToDataUrl = function($control, $image, blob) {
...
//---------------------------------------------------------------------------------
FwAppImage.getAppImages = function($control) {
    var request;
    request = {};
...
//---------------------------------------------------------------------------------
FwAppImage.setGetAppImagesRequest = function($control, request) {
...
//---------------------------------------------------------------------------------
FwAppImage.addImage = function($control, $image) {
...
//---------------------------------------------------------------------------------
FwAppImage.deleteImage = function($control, $image) {
