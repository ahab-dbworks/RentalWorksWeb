...
FwAudit.getDesignerProperties = function() {
    ...
    propClass.defaultvalue = 'fwcontrol fwaudit';
...
FwAudit.loadAudit = function($form, uniqueid) {
    ...
    $auditHistoryGridControl = jQuery(jQuery('#tmpl-grids-AuditHistoryBrowse').html());
    $auditHistoryGrid.empty().append($auditHistoryGridControl);
    $auditHistoryGridControl.data('ondatabind', function(request) {
        request.module = 'AuditHistory';
        request.uniqueid = uniqueid;
        FwServices.grid.method(request,'AuditHistory', 'Browse', $form, function(response) {
