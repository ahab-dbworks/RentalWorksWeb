...
namespace FwCore.Services
{
    public class FwModule
    {
        ...
        public virtual void Load()
        {
            ...
            string tabName;
            this.form.Mode = FwCore.Services.FwForm.Modes.EDIT;
        ...
        public virtual void Save()
        {
            ...
            this.form.Mode = (FwCore.Services.FwForm.Modes)Enum.Parse(typeof(FwCore.Services.FwForm.Modes), this.request.mode);
            this.gatherData();
            ...
            if (isValid)
            {
                ...
                {
                    case FwCore.Services.FwForm.Modes.NEW:
                        this.beforeInsert();
                        this.insert();
                        this.afterInsert();
                        this.form.Mode = FwForm.Modes.EDIT;
                        break;
                    case FwCore.Services.FwForm.Modes.EDIT:
                        this.beforeUpdate();
                        this.update();
                        this.afterUpdate();
                        break;
