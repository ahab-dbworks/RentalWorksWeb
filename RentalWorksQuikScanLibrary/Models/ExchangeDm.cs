...
using RentalWorksQuikScanLibrary.Models.ExchangeModels;
using static Fw.Json.SqlServer.FwSqlData;
...
namespace RentalWorksQuikScanLibrary.Services
{
    class ExchangeDm
    {
        ...
        {
            exchange.frmInExchangeItem = new Models.ExchangeModels.ExchangeItem();
            exchange.frmInExchangeItem.clearitem = true;
        }
        //---------------------------------------------------------------------------------------------
        public static void clearoutitem(ExchangeModel exchange)
        {
            exchange.frmOutExchangeItem = new Models.ExchangeModels.ExchangeItem();
