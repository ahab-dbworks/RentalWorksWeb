class TiwUser extends User {
    ...
    getBrowseTemplate() {
        return `
      <div data-name="User" data-control="FwBrowse" data-type="Browse" id="UserBrowse" class="fwcontrol fwbrowse" data-orderby="Name" data-controller="TiwUserController" data-hasinactive="true">
    ...
    getFormTemplate() {
        return `
      <div id="userform" class="fwcontrol fwcontainer fwform" data-control="FwContainer" data-type="form" data-version="1" data-caption="User" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="TiwUserController">
...
var TiwUserController = new TiwUser();
//# sourceMappingURL=TiwUser.js.map