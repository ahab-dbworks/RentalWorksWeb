class EmailHistory {
    constructor() {
        ...
        this.caption = 'Email History';
        this.nav = 'module/emailhistory';
        this.id = '3F44AC27-CE34-46BA-B4FB-A8AEBB214167';
    ...
    addBrowseMenuItems($menuObject) {
        ...
        let sentBy = [];
        sentBy.push($me, $all);
        FwMenu.addViewBtn($menuObject, 'Sent By', sentBy, true, "FromUserId");
        return $menuObject;
    }
    ;
    openForm(mode) {
