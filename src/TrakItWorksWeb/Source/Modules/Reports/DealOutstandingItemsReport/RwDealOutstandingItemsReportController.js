routes.push({
    pattern: /^reports\/dealoutstandingitemsreport/, action: function (match) {
...
;
var RwDealOutstandingItemsReportController = new RwDealOutstandingItemsReportClass();
//# sourceMappingURL=RwDealOutstandingItemsReportController.js.map