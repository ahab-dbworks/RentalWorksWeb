    ...
    initMainMenu() {
        this.navigation = [
            ...
            },
            {
                ...
                children: [AssetController, RepairController, InventoryItemController/*, SalesInventoryController, PartsInventoryController, ContainerController*/]
          },
            {
                caption: 'Warehouse',
            ...
            },
            {
                ...
                children: [GroupController, UserController/*ControlController, CustomFieldController, CustomFormController, DuplicateRuleController, HotfixController, SettingsController, ReportsController*/]
            }
        ];
    }
    //----------------------------------------------------------------------------------------------
