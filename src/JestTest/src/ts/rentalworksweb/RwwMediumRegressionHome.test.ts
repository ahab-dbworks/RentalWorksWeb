...
import {
    ...
    Region, RepairItemStatus, SetCondition, SetSurface, SetOpening, WallDescription, WallType, ShipVia, Source, AvailabilitySettings, EmailSettings,
    LogoSettings, DocumentBarCodeSettings, SystemSettings, TaxOption, Template, UserStatus, Sound, LicenseClass, VehicleColor, VehicleFuelType, VehicleMake, VehicleScheduleStatus, VehicleStatus,
    ...
    WardrobeMaterial, WardrobePattern, WardrobePeriod, WardrobeSource,  Widget, WorkWeek,
