...
if %testnumber%==6  (call :runtest "RwwMediumRegressionAdmin" "Medium_Regression_Administrator")
if %testnumber%==0  (call :runtest "RwwMediumRegressionSettings01" "Medium_Regression_Settings_01")
if %testnumber%==7  (call :runtest "RwwMediumRegressionSettings01" "Medium_Regression_Settings_01")
if %testnumber%==0  (call :runtest "RwwMediumRegressionSettings02" "Medium_Regression_Settings_02")
if %testnumber%==8  (call :runtest "RwwMediumRegressionSettings02" "Medium_Regression_Settings_02")
if %testnumber%==0  (call :runtest "RwwMediumRegressionSettings03" "Medium_Regression_Settings_03")
if %testnumber%==9  (call :runtest "RwwMediumRegressionSettings03" "Medium_Regression_Settings_03")
if %testnumber%==0  (call :runtest "RwwMediumRegressionSettings04" "Medium_Regression_Settings_04")
if %testnumber%==10 (call :runtest "RwwMediumRegressionSettings04" "Medium_Regression_Settings_04")
if %testnumber%==0  (call :runtest "RwwMediumRegressionSettings05" "Medium_Regression_Settings_05")
if %testnumber%==11 (call :runtest "RwwMediumRegressionSettings05" "Medium_Regression_Settings_05")
if %testnumber%==0  (call :runtest "RwwInventoryIntegrity" "Inventory_Integrity")
if %testnumber%==12 (call :runtest "RwwInventoryIntegrity" "Inventory_Integrity")
if %testnumber%==0  (call :runtest "RwwTransfers" "Transferring_Inventory")
if %testnumber%==13 (call :runtest "RwwTransfers" "Transferring_Inventory")
if %testnumber%==0  (call :runtest "RwwRunReports" "Reports")
if %testnumber%==14 (call :runtest "RwwRunReports" "Reports")
