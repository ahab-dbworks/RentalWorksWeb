...
if %testnumber%==2  (call :runtest "RwwShallowRegressionHome" "Shallow_Regression_Home")
if %testnumber%==3  (call :runtest "RwwShallowRegressionSettings01" "Shallow_Regression_Settings_01")
if %testnumber%==4  (call :runtest "RwwShallowRegressionSettings02" "Shallow_Regression_Settings_02")
if %testnumber%==5  (call :runtest "RwwShallowRegressionSettings03" "Shallow_Regression_Settings_03")
if %testnumber%==6  (call :runtest "RwwShallowRegressionAdmin" "Shallow_Regression_Admin")
if %testnumber%==7  (call :runtest "RwwMediumRegressionHome01" "Medium_Regression_Home_01")
if %testnumber%==8  (call :runtest "RwwMediumRegressionHome02" "Medium_Regression_Home_02")
if %testnumber%==9  (call :runtest "RwwMediumRegressionHome03" "Medium_Regression_Home_03")
if %testnumber%==10 (call :runtest "RwwMediumRegressionHome04" "Medium_Regression_Home_04")
if %testnumber%==11 (call :runtest "RwwMediumRegressionAdmin" "Medium_Regression_Administrator")
if %testnumber%==12 (call :runtest "RwwMediumRegressionSettings01" "Medium_Regression_Settings_01")
if %testnumber%==13 (call :runtest "RwwMediumRegressionSettings02" "Medium_Regression_Settings_02")
if %testnumber%==14 (call :runtest "RwwMediumRegressionSettings03" "Medium_Regression_Settings_03")
if %testnumber%==15 (call :runtest "RwwMediumRegressionSettings04" "Medium_Regression_Settings_04")
if %testnumber%==16 (call :runtest "RwwMediumRegressionSettings05" "Medium_Regression_Settings_05")
if %testnumber%==17 (call :runtest "RwwInventoryIntegrity" "Inventory_Integrity")
if %testnumber%==18 (call :runtest "RwwTransfers" "Transferring_Inventory")
if %testnumber%==19 (call :runtest "RwwRunReports" "Reports")
