...
if %testnumber%==17 (call :runtest "RwwMediumRegressionHome08" "Medium_Regression_Home_08")
if %testnumber%==18 (call :runtest "RwwMediumRegressionHome09" "Medium_Regression_Home_09")
if %testnumber%==19 (call :runtest "RwwMediumRegressionAdmin" "Medium_Regression_Administrator")
if %testnumber%==20 (call :runtest "RwwMediumRegressionSettings01" "Medium_Regression_Settings_01")
if %testnumber%==21 (call :runtest "RwwMediumRegressionSettings02" "Medium_Regression_Settings_02")
if %testnumber%==22 (call :runtest "RwwMediumRegressionSettings03" "Medium_Regression_Settings_03")
if %testnumber%==23 (call :runtest "RwwMediumRegressionSettings04" "Medium_Regression_Settings_04")
if %testnumber%==24 (call :runtest "RwwMediumRegressionSettings05" "Medium_Regression_Settings_05")
if %testnumber%==25 (call :runtest "RwwMediumRegressionSettings06" "Medium_Regression_Settings_06")
if %testnumber%==26 (call :runtest "RwwMediumRegressionSettings07" "Medium_Regression_Settings_07")
if %testnumber%==27 (call :runtest "RwwMediumRegressionSettings08" "Medium_Regression_Settings_08")
if %testnumber%==28 (call :runtest "RwwMediumRegressionSettings09" "Medium_Regression_Settings_09")
if %testnumber%==29 (call :runtest "RwwMediumRegressionSettings10" "Medium_Regression_Settings_10")
