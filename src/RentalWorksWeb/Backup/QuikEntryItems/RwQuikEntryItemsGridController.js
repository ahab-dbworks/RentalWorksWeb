//----------------------------------------------------------------------------------------------
var RwQuikEntryItemsGridController = {};
//----------------------------------------------------------------------------------------------
RwQuikEntryItemsGridController.init = function ($control) {
    $control
...
//----------------------------------------------------------------------------------------------
RwQuikEntryItemsGridController.afterDelete = function($control, $tr) {
    var $form, $quikEntryItemsBrowse;

    $form              = $control.closest('.fwform');
    $quikEntryItemsBrowse = $form.find('div[data-name="QuikEntryItems"][data-control="FwBrowse"]');
    FwBrowse.search($quikEntryItemsBrowse);
}
//----------------------------------------------------------------------------------------------
RwQuikEntryItemsGridController.getActions = function($control) {
    var actions = [
...
//----------------------------------------------------------------------------------------------
RwQuikEntryItemsGridController.onAction = function($control, $form, action, uniqueids) {
    var request = {};
    switch(action) {
        case 'ACTIVATE':
            if (confirm('Activate record?')) {
                ...
                FwServices.setcompanycontactstatus(request, $control, function(response) {
                    var $orderNoteBrowse;
                    $orderNoteBrowse = $form.find('div[data-name="QuikEntryItems"][data-control="FwBrowse"]');
...
//----------------------------------------------------------------------------------------------
RwQuikEntryItemsGridController.addGridSubMenu = function($control, $menu) {
