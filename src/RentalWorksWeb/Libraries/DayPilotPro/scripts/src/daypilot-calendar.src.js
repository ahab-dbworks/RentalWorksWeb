...
/*
        ...
        */
        ...
        this._getColumns = function(level, inherit) {
            var source = this.columns || this._columnsBottom;
            var list = [];
        ...
        this._drawHeaderRow = function(level, create) {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (lastRow) { // use the width spec only for the last row, otherwise use colspan
                    ...
                    if (calendar.columnWidthSpec === "Fixed") {
                        if (data.width) {
                            cell.style.width = data.width + "px";
                        }
                        else {
                            cell.style.width = calendar.columnWidth + "px";
                        }
                    }
                    */
...
*/
        ...
        this._onEventMouseDown = function(ev) {
            ...
            else if ((this.style.cursor === 'move' || (calendar.moveBy === 'Full' && calendar.eventMoveHandling !== 'Disabled')) && button.left) {
