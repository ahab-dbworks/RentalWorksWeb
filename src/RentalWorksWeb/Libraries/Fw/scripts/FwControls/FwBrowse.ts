            ...
            FwAppData.apiMethod(true, 'GET', `${(<any>window[controller]).apiurl}/emptyobject`, null, FwServices.defaultTimeout, function onSuccess(response) {
                ...
                let myExcelXML = (function () {
                    ...
                    let fs, SheetName = 'SHEET 1',
                        styleID = 1, columnWidth = 80, uri, link;
                    let fileName = `${controller.substring(0, controller.length - 10)}Browse-Fields`;
                    class myExcelXML {
                        constructor(o) {
                ...
                var myTestXML = new myExcelXML(JSON.stringify(fields));
                myTestXML.downLoad();
