            ...
            children: {
                ...
                BillingReports: {
                    ...
                    children: {
                        ...
                        InvoiceReport:                    { id: 'o5nbWmTr7xy0n', caption: 'Invoice',                      nav: 'reports/invoicereport',                    nodetype: 'Module', description: 'Invoice document.' },
                ...
                OrderReports: {
                    ...
                    children: {
                        ...
                        ManifestReport:             { id: '8lSfSBPXlYh5',  caption: 'Print Value Sheet',           nav: 'reports/manifestreport',             nodetype: 'Module', description: 'Gets item manifest information' },
                        ...
                        OrderReport:                { id: 'Q89Ni6FvVL92',  caption: 'Order',                       nav: 'reports/orderreport',                nodetype: 'Module', description: 'Order document.' },
                        ...
                        QuoteReport:                { id: 'SZ80uvR5NjI7',  caption: 'Quote',                       nav: 'reports/quotereport',                nodetype: 'Module', description: 'Quote document.' },
                ...
                RentalInventoryReports: {
                    ...
                    nodetype: 'Category',
                    children: {
                        FixedAssetBookValueReport:                { id: '03HEFOHpPOEm',  caption: 'Rental Inventory Fixed Asset Book Value',   nav: 'reports/fixedassetbookvaluereport',                nodetype: 'Module', description: 'List all Fixed Asset Inventory items and get a current or historical Book Value.' },
                        FixedAssetDepreciationReport:             { id: '3KJaC5Kc7149',  caption: 'Rental Inventory Fixed Asset Depreciation', nav: 'reports/fixedassetdepreciationreport',             nodetype: 'Module', description: 'List Depreciation for all Fixed Asset Inventory items over a given date range.' },
