    ...
    initMainMenu() {
        this.navigation = [
            ...
            },
            {
                ...
                children: [RentalInventoryController, SalesInventoryController, PartsInventoryController, AssetController, ContainerController, RepairController, CompleteQcController]
            },
            {
                caption: 'Warehouse',
