                  ...
                  <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:1 1 350px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Quote">
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield" data-caption="Quote No." data-datafield="QuoteNumber" data-enabled="false" style="flex:1 1 100px;"></div>
                          <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield" data-caption="Version" data-datafield="VersionNumber" data-enabled="false" style="flex:1 1 50px;"></div>
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield" data-caption="Converted to Order" data-datafield="ConvertedToOrderId" data-displayfield="ConvertedToOrderNumber" data-validationname="OrderValidation" data-enabled="false" style="flex:1 1 100px;"></div>
                        </div>
                        <div class="flexrow">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield RateType" data-caption="Rate" data-datafield="RateType" data-displayfield="RateTypeDisplay" data-validationname="RateTypeValidation" data-validationpeek="false" data-required="true" style="flex:1 1 275px;"></div>
                        </div>
                        <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn rentalsaletotals rentalsaleadjustments summarySection" style="flex:0 0 200px;padding-right:10px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Sales Adjustments">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals lossOrderItemTotal bottom_line_total_tax" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="RS" data-datafield="RentalSaleTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield lossTotalWithTax bottom_line_total_tax" data-caption="Include Tax in Total" data-rectype="RS" data-datafield="RentalSaleTotalIncludesTax" style="flex:1 1 175px;margin-top:10px;"></div>
                        </div>
                      </div>
                    </div>
                  </div>
