class Order extends OrderBase {
    ...
    afterLoad($form, response) {
        ...
        if (!FwFormField.getValueByDataField($form, 'HasRepair')) {
            ...
            this.hideTab($form, 'repairtab');
        } else {
            //$form.find('[data-type="tab"][data-caption="Repair"]').show();
            this.showTab($form, 'repairtab');
        }
        //On Demand Billing Cycles require a worksheet tab
        //const worksheetTab = $form.find('[data-type="tab"][data-caption="Billing Worksheet"]');
        const worksheetTab = this.getTab($form, 'billingworksheettab');
        ...
        <div id="orderform" class="fwcontrol fwcontainer fwform orderform" data-control="FwContainer" data-type="form" data-version="1" data-caption="Order" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="OrderController">
          ...
          <div id="orderform-tabcontrol" class="fwcontrol fwtabs" data-control="FwTabs" data-type="">
            <div class="tabs">
              ...
              <div data-type="tab" id="rentalsaletab" class="tab rentalsaletab notcombinedtab" data-tabpageid="rentalsaletabpage" data-notOnNew="true" data-caption="Rental Sale"></div>
            ...
            <div class="tabpages">
                  ...
                  <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:1 1 350px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Order">
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield" data-caption="Original Quote" data-datafield="SourceQuoteId" data-displayfield="SourceQuoteNumber" data-validationname="QuoteValidation" data-enabled="false" style="flex:1 1 100px;"></div>
                        </div>
                        <div class="flexrow">
                        ...
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield" data-caption="Department" data-datafield="Department" style="display:none;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield" data-caption="Customer" data-datafield="CustomerId" data-displayfield="Customer" data-validationname="CustomerValidation" data-required="false" data-enabled="false" style="flex:1 1 275px;"></div>
                          <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield dealnumber" data-caption="Customer No." data-datafield="CustomerNumber" data-enabled="false" style="flex:1 1 100px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield" data-caption="Deal" data-datafield="DealId" data-displayfield="Deal" data-validationname="DealValidation" data-formbeforevalidate="beforeValidateDeal" data-required="true" style="flex:1 1 275px;"></div>
                          ...
                          <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield" data-caption="Deal" data-datafield="Deal" style="display:none;"></div>
                        </div>
                        <div class="flexrow">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Activity">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield anti-LD activity" data-caption="Rental Sale" data-datafield="RentalSale" style="flex:1 1 100px;"></div>
                        </div>
                        <div class="flexrow">
                        ...
                        <div class="flexrow" style="display:none;">
                          ...
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="HasDocuments" data-datafield="HasDocuments" style="flex:1 1 100px;"></div>
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="HasEmailHistory" data-datafield="HasEmailHistory" style="flex:1 1 100px;"></div>
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="HasContacts" data-datafield="HasContacts" style="flex:1 1 100px;"></div>
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="HasSubPurchaseOrders" data-datafield="HasSubPurchaseOrders" style="flex:1 1 100px;"></div>
                          <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="HasPickLists" data-datafield="HasPickLists" style="flex:1 1 100px;"></div>
                    ...
                    <div class="flexcolumn" style="flex:1 1 300px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Market">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="validation" class="fwcontrol fwformfield" data-caption="Job" data-datafield="MarketSegmentJobId" data-displayfield="MarketSegmentJob" data-validationpeek="false" data-formbeforevalidate="beforeValidateMarketSegment" data-validationname="MarketSegmentJobValidation" style="flex:1 1 150px;"></div>
                        </div>
                      </div>
                    </div>
              ...
              <div data-type="tabpage" id="profitlosstabpage" class="profitlossgrid tabpage" data-tabid="profitlosstab" data-render="false">
                <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Profit &amp; Loss Summary">
                  ...
                  <div class="wideflexrow">
                    ...
                    <!-- Rental Sale Profitability -->
                    <div class="flexcolumn rentalsale-pl" style="flex:0 1 200px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Sales">
                        <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn summarySection" style="flex:0 1 200px;padding-right:10px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Totals">
                        ...
                        <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Gross Total" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="GrossTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow rentaltotals">
                        ...
                        <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Sub-Total" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="SubTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Tax" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Tax" data-taxtype="Rental" style="flex:1 1 175px;"></div>
                        </div>
                         <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Tax 2" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Tax2" data-taxtype="Rental" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Total" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Total" style="flex:1 1 175px;"></div>
                        </div>
                      </div>
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Adjustments">
                        ...
                        <div class="flexrow rentalAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals rentalOrderItemTotal bottom_line_total_tax rentalAdjustmentsPeriod" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="R" data-datafield="PeriodRentalTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow rentalAdjustments">
                        ...
                        <div class="flexrow rentalAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals rentalOrderItemTotal bottom_line_total_tax rentalAdjustmentsWeekly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="R" data-datafield="WeeklyRentalTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow rentalAdjustments">
                        ...
                        <div class="flexrow rentalAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals rentalOrderItemTotal bottom_line_total_tax rentalAdjustmentsMonthly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="R" data-datafield="MonthlyRentalTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow rentalAdjustments">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn summarySection" style="flex:0 0 200px;padding-right:10px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Sales Adjustments">
                        ...
                        <div class="flexrow salesAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals salesOrderItemTotal bottom_line_total_tax" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="S" data-datafield="SalesTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow salesAdjustments">
              ...
              <div data-type="tabpage" id="misctabpage" class="miscgrid notcombined tabpage" data-tabid="misctab" data-render="false">
                <div class="wideflexrow">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn summarySection" style="flex:0 0 200px;padding-right:10px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Miscellaneous Totals">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Miscellaneous Adjustments">
                        ...
                        <div class="flexrow miscAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals miscOrderItemTotal bottom_line_total_tax miscAdjustmentsPeriod" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="M" data-datafield="PeriodMiscTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow miscAdjustments">
                        ...
                        <div class="flexrow miscAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals miscOrderItemTotal bottom_line_total_tax miscAdjustmentsWeekly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="M" data-datafield="WeeklyMiscTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow miscAdjustments">
                        ...
                        <div class="flexrow miscAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals miscOrderItemTotal bottom_line_total_tax miscAdjustmentsMonthly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="M" data-datafield="MonthlyMiscTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow miscAdjustments">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn labortotals laboradjustments summarySection" style="flex:0 0 200px;padding-right:10px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Labor Totals">
                        ...
                        <div class="flexrow labortotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Tax" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Tax" data-taxtype="Labor" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow labortotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Tax 2" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Tax2" data-taxtype="Labor" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow labortotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals" data-caption="Total" data-currencysymbol="CurrencySymbol" data-datafield="" data-enabled="false" data-totalfield="Total" style="flex:1 1 175px;"></div>
                        </div>
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Labor Adjustments">
                        ...
                        <div class="flexrow laborAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals laborOrderItemTotal bottom_line_total_tax laborAdjustmentsPeriod" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="L" data-datafield="PeriodLaborTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow laborAdjustments">
                        ...
                        <div class="flexrow laborAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals laborOrderItemTotal bottom_line_total_tax laborAdjustmentsWeekly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="L" data-datafield="WeeklyLaborTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow laborAdjustments">
                        ...
                        <div class="flexrow laborAdjustments">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals laborOrderItemTotal bottom_line_total_tax laborAdjustmentsMonthly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="L" data-datafield="MonthlyLaborTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow laborAdjustments">
              ...
              <!-- RENTAL SALE TAB -->
              <div data-type="tabpage" id="rentalsaletabpage" class="rentalsalegrid notcombined tabpage" data-tabid="rentalsaletab" data-render="false">
                <div class="wideflexrow">
                  <div class="flexcolumn" style="flex:1 1 600px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Sale Items">
                      <div class="wideflexrow">
                        <div data-control="FwGrid" data-grid="OrderItemGrid" data-securitycaption="Rental Sale Items"></div>
                      </div>
                    </div>
                  </div>
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn rentalsaletotals rentalsaleadjustments summarySection" style="flex:0 0 200px;padding-right:10px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Sales Totals">
                        <div class="flexrow rentalsaletotals">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn summarySection" style="flex:0 0 200px;padding-right:10px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="L&D Adjustments">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals lossOrderItemTotal bottom_line_total_tax" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="F" data-datafield="LossAndDamageTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:0 0 auto;">
                    <div class="flexcolumn summarySection" style="flex:0 0 200px;padding-right:10px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Order Adjustments">
                        ...
                        <div class="flexrow combinedtotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals combinedOrderItemTotal bottom_line_total_tax combinedAdjustmentsPeriod" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="" data-datafield="PeriodCombinedTotal" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow combinedtotals">
                        ...
                        <div class="flexrow combinedtotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals combinedOrderItemTotal bottom_line_total_tax combinedAdjustmentsWeekly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="" data-datafield="WeeklyCombinedTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow combinedtotals">
                        ...
                        <div class="flexrow combinedtotals">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals combinedOrderItemTotal bottom_line_total_tax combinedAdjustmentsMonthly" data-caption="Total" data-currencysymbol="CurrencySymbol" data-rectype="" data-datafield="MonthlyCombinedTotal" style="flex:1 1 175px; display:none;"></div>
                        </div>
                        <div class="flexrow combinedtotals">
                    ...
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Billing">
                      ...
                      <div class="flexrow date-types" style="display:none;">
                        <div class="flexcolumn">
                          ...
                          <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Miscellaneous Billing Period">
                            <div class="flexrow">
                      ...
                      <div class="flexrow">
                        ...
                        <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield" data-caption="" data-datafield="Currency" style="display:none;"></div>
                        <div data-control="FwFormField" data-type="validation" data-validationname="CurrencyCodeValidation" class="fwcontrol fwformfield" data-caption="Currency" data-datafield="CurrencyId" data-required="true" data-displayfield="CurrencyCode" style="flex:1 1 250px;"></div>
                      </div>
                      <div class="flexrow">
                      ...
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Rental" data-caption="Rental" data-datafield="RentalTaxRate1" data-enabled="false" style="flex:1 1 75px;"></div>
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Sales" data-caption="Sales" data-datafield="SalesTaxRate1" data-enabled="false" style="flex:1 1 75px;"></div>
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Labor" data-caption="Labor" data-datafield="LaborTaxRate1" data-enabled="false" style="flex:1 1 75px;"></div>
                      </div>
                     <div class="flexrow">
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Rental" data-caption="Rental" data-datafield="RentalTaxRate2" data-enabled="false" style="flex:1 1 75px; display:none;"></div>
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Sales" data-caption="Sales" data-datafield="SalesTaxRate2" data-enabled="false" style="flex:1 1 75px; display:none;"></div>
                        <div data-control="FwFormField" data-type="percent" data-digits="4" class="fwcontrol fwformfield" data-taxtype="Labor" data-caption="Labor" data-datafield="LaborTaxRate2" data-enabled="false" style="flex:1 1 75px; display:none;"></div>
                      </div>
                      <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:1 1 425px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Outgoing">
                        ...
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="timepicker" data-timeformat="24" class="fwcontrol fwformfield" data-caption="On Time" data-datafield="OutDeliveryTargetShipTime" style="flex:1 1 75px;"></div>
                          ...
                          <div data-control="FwFormField" data-type="timepicker" data-timeformat="24" class="fwcontrol fwformfield" data-caption="Required Time" data-datafield="OutDeliveryRequiredTime" style="flex:1 1 75px;"></div>
                        </div>
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="phoneinternational" class="fwcontrol fwformfield" data-caption="Phone" data-datafield="OutDeliveryToContactPhone" style="flex:1 1 250px;"></div>
                        </div>
                        <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:1 1 425px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Incoming">
                        ...
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="timepicker" data-timeformat="24" class="fwcontrol fwformfield" data-caption="On Time" data-datafield="InDeliveryTargetShipTime" style="flex:1 1 75px;"></div>
                          ...
                          <div data-control="FwFormField" data-type="timepicker" data-timeformat="24" class="fwcontrol fwformfield" data-caption="Required Time" data-datafield="InDeliveryRequiredTime" style="flex:1 1 75px;"></div>
                        </div>
                        <div class="flexrow">
                          ...
                          <div data-control="FwFormField" data-type="phoneinternational" class="fwcontrol fwformfield" data-caption="Phone" data-datafield="InDeliveryToContactPhone" style="flex:1 1 250px;"></div>
                        </div>
                        <div class="flexrow">
                ...
                <div class="wideflexrow">
                  <div class="flexcolumn manifest-totals" style="flex:0 1 175px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Order Total">
                      ...
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Replacement Cost" data-datafield="OrderReplacementTotal" data-currencysymbol="CurrencySymbol" data-enabled="false"></div>
                      </div>
                    </div>
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Owned Total">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Value" data-datafield="OwnedValueTotal" data-currencysymbol="CurrencySymbol" data-enabled="false"></div>
                      </div>
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Replacement Cost" data-datafield="OwnedReplacementTotal" data-currencysymbol="CurrencySymbol" data-enabled="false"></div>
                      </div>
                    </div>
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Sub-Rental Total">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Value" data-datafield="SubValueTotal" data-currencysymbol="CurrencySymbol" data-enabled="false"></div>
                      </div>
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Replacement Cost" data-datafield="SubReplacementTotal" data-currencysymbol="CurrencySymbol" data-enabled="false"></div>
                      </div>
                    </div>
