                    ...
                    <div class="flexcolumn" style="flex:0 1 425px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Billing Options">
                        ...
                        <div class="flexrow">
                          ...
                          <div data-datafield="MultipleCurrencies" data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield" data-caption="This Customer uses multiple Currencies. Use the Office Location default Currency when creating new Purchase Orders" style="flex:1 1 200px;"></div>
                        </div>
                      </div>
                  ...
                  <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:0 1 425px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Credit">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Customer A/R Balance" data-datafield="CreditBalance" data-currencysymbol="CurrencySymbol" data-enabled="false" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield" data-caption="Available" data-datafield="CreditAvailable" data-currencysymbol="CurrencySymbol" data-enabled="false" style="flex:1 1 175px;"></div>
                        </div>
                        <div class="flexrow">
                  ...
                  <div class="flexrow">
                    <div class="flexcolumn" style="flex:0 1 425px;">
                      ...
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Insurance">
                        ...
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="number" data-digits="0" class="fwcontrol fwformfield officelocation" data-caption="Liability Amount" data-datafield="InsuranceCoverageLiability" style="flex:1 1 125px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="number" data-digits="0" class="fwcontrol fwformfield vendorclass" data-caption="Liability Deductible" data-datafield="InsuranceCoverageLiabilityDeductible" style="flex:1 1 125px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="number" data-digits="0" class="fwcontrol fwformfield vendorclass" data-caption="Property Value Amount" data-datafield="InsuranceCoveragePropertyValue" style="flex:1 1 125px;"></div>
                        </div>
                        <div class="flexrow">
                          <div data-control="FwFormField" data-type="number" data-digits="0" class="fwcontrol fwformfield vendorclass" data-caption="Property Value Deductible" data-datafield="InsuranceCoveragePropertyValueDeductible" style="flex:1 1 125px;"></div>
                        </div>
                        <div class="flexrow">
