    ...
    getBrowseTemplate(): string {
      ...
      <div data-name="Manifest" data-control="FwBrowse" data-type="Browse" id="ManifestBrowse" class="fwcontrol fwbrowse" data-controller="ManifestController" data-hasinactive="false">
        ...
        <div class="column" data-width="auto" data-visible="true">
          <div class="field" data-caption="No." data-datafield="ManifestNumber" data-datatype="text" data-sort="desc" data-sortsequence="3" data-searchfieldoperators="startswith"></div>
        </div>
        <div class="column" data-width="auto" data-visible="true">
          <div class="field" data-caption="Date" data-datafield="ManifestDate" data-datatype="date" data-sortsequence="1" data-sort="off"></div>
        </div>
        <div class="column" data-width="auto" data-visible="true">
          <div class="field" data-caption="Time" data-datafield="ManifestTime" data-datatype="text" data-sortsequence="2" data-sort="off"></div>
        </div>
        <div class="column" data-width="auto" data-visible="true">
        ...
        <div class="column" data-width="auto" data-visible="true">
         ...
         <div class="column" data-width="auto" data-visible="true">
          <div class="field" data-caption="Contract Type" data-datafield="ContractType" data-datatype="text" data-sort="off"></div>
        </div>
      </div>`;
    }
    //----------------------------------------------------------------------------------------------
