...
var Order = (function () {
    ...
    Order.prototype.typeOnClickEvents = function ($popup, $form, availableFor) {
        var $searchpopup = jQuery('#searchpopup');
    ...
    Order.prototype.categoryOnClickEvents = function ($popup, $form, availableFor) {
        var $searchpopup = jQuery('#searchpopup');
    ...
    ;
    Order.prototype.subCategoryOnClickEvents = function ($popup, $form, availableFor) {
        var $searchpopup = jQuery('#searchpopup');
    ...
    Order.prototype.breadCrumbs = function ($popup, $form, availableFor) {
        var $searchpopup = jQuery('#searchpopup');
