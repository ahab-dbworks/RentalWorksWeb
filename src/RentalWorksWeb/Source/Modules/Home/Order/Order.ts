    ...
    copyOrder($form) {
        ...
        $yes.on('click', function () {
            try {
                ...
                //FwAppData.apiMethod(true, 'POST', 'api/v1/order/copy/' + orderId, {}, FwServices.defaultTimeout, function onSuccess(response) {
                //    FwNotification.renderNotification('SUCCESS', 'Order Successfully Copied');
                //    FwConfirmation.destroyConfirmation($confirmation);
                //    console.log(response, "Order Copied:" + orderId);
