                ...
                <div class="wideflexrow">
                  ...
                  <div class="flexcolumn" style="flex:1 1 125px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Facilities">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Sub-Total" data-datafield="" data-framedatafield="FacilitiesPrice"></div>
                      </div>
                      <div class="flexrow">
                      ...
                      <div class="flexrow totalColors">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Total" data-datafield="" data-framedatafield="FacilitiesTotal"></div>
                      </div>
                      <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:1 1 125px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Transportation">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Sub-Total" data-datafield="" data-framedatafield="TransportationPrice"></div>
                      </div>
                      <div class="flexrow">
                      ...
                      <div class="flexrow totalColors">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Total" data-datafield="" data-framedatafield="TransportationTotal"></div>
                      </div>
                      <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:1 1 175px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Parts">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Sub-Total" data-datafield="" data-framedatafield="PartsPrice"></div>
                      </div>
                      <div class="flexrow">
                      ...
                      <div class="flexrow totalColors">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield frame" data-caption="Total" data-datafield="" data-framedatafield="PartsTotal"></div>
                      </div>
                      <div class="flexrow">
                    ...
                    <div class="flexcolumn" style="flex:0 0 200px;padding-right:10px;">
                      <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Rental Totals">
                        <div class="flexrow rentaltotals">
                          <div data-control="FwFormField" data-type="togglebuttons" class="fwcontrol fwformfield totals totalType" data-caption="View" data-datafield="totalTypeRental" style="flex:1 1 150px;"></div>
                        </div>
                        <div class="flexrow rentaltotals">
                ...
                <div class="wideflexrow">
                  ...
                  <div class="flexcolumn labortotals laboradjustments" style="flex:0 0 200px;padding-right:10px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Labor Totals">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="togglebuttons" class="fwcontrol fwformfield totals totalType" data-caption="View" data-datafield="totalTypeLabor" style="flex:1 1 150px;"></div>
                      </div>
                ...
                <div class="wideflexrow">
                  ...
                  <div class="flexcolumn" style="flex:0 0 200px;padding-right:10px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Misc Totals">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="togglebuttons" class="fwcontrol fwformfield totals totalType" data-caption="View" data-datafield="totalTypeMisc" style="flex:1 1 150px;"></div>
                      </div>
                  ...
                  <div class="flexcolumn usedsaletotals usedsaleadjustments" style="flex:0 0 200px;padding-right:10px;">
                    ...
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Used Sales Adjustments">
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="percent" class="fwcontrol fwformfield totals bottom_line_discount" data-caption="Disc. %" data-rectype="L" data-datafield="UsedSaleDiscountPercent" style="flex:1 1 50px;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals usedSaleOrderItemTotal bottom_line_total_tax laborAdjustmentsPeriod" data-caption="Total" data-rectype="L" data-datafield="PeriodUsedSaleTotal" style="flex:1 1 100px;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield usedSaleTotalWithTax bottom_line_total_tax laborAdjustmentsPeriod" data-caption="Include Tax in Total" data-rectype="L" data-datafield="PeriodUsedSaleTotalIncludesTax" style="flex:1 1 75px;margin-top:10px;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals usedSaleOrderItemTotal bottom_line_total_tax laborAdjustmentsWeekly" data-caption="Total" data-rectype="L" data-datafield="WeeklyUsedSaleTotal" style="flex:1 1 100px; display:none;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield usedSaleTotalWithTax bottom_line_total_tax laborAdjustmentsWeekly" data-caption="Include Tax in Total" data-rectype="L" data-datafield="WeeklyUsedSaleTotalIncludesTax" style="flex:1 1 75px;margin-top:10px; display:none;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="money" class="fwcontrol fwformfield totals usedSaleOrderItemTotal bottom_line_total_tax laborAdjustmentsMonthly" data-caption="Total" data-rectype="L" data-datafield="MonthlyUsedSaleTotal" style="flex:1 1 100px; display:none;"></div>
                      </div>
                      <div class="flexrow usedsaleAdjustments">
                        <div data-control="FwFormField" data-type="checkbox" class="fwcontrol fwformfield usedSaleTotalWithTax bottom_line_total_tax laborAdjustmentsMonthly" data-caption="Include Tax in Total" data-rectype="L" data-datafield="MonthlyUsedSaleTotalIncludesTax" style="flex:1 1 75px;margin-top:10px; display:none;"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="flexrow">
                  ...
                  <div class="flexcolumn" style="flex:1 1 325px;">
                    <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Billing">
                      <div class="flexrow">
                        <div data-control="FwFormField" data-type="date" class="fwcontrol fwformfield billing_start_date" data-caption="Start" data-datafield="BillingStartDate" style="flex:1 1 100px;"></div>
                        <div data-control="FwFormField" data-type="date" class="fwcontrol fwformfield billing_end_date" data-caption="Stop" data-datafield="BillingEndDate" style="flex:1 1 100px;"></div>
                      </div>
                      <div class="flexrow">
                      ...
                      <div class="flexrow">
                        ...
                        <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield BillingWeeks week_or_month_field" data-caption="Weeks" data-datafield="BillingWeeks" style="flex:1 1 50px;"></div>
                        <div data-control="FwFormField" data-type="text" class="fwcontrol fwformfield BillingMonths week_or_month_field" data-caption="Months" data-datafield="BillingMonths" style="flex:1 1 50px;"></div>
                      </div>
                      <div class="flexrow">
