routes.push({
    pattern: /^reports\/incomingshippinglabel/, action: function (match: RegExpExecArray) {
        return IncomingShippingLabelController.getModuleScreen();
    }
});

const incomingShippingLabelTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport print-invoice" data-control="FwContainer" data-type="form" data-version="1" data-caption="" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="IncomingShippingLabelController">
        ...
        <div class="formpage">
          <div class="row" style="display:flex;flex-wrap:wrap;">
            <div class="flexcolumn" style="max-width:500px;">
              <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Incoming Shipping Label">
...
//----------------------------------------------------------------------------------------------
class IncomingShippingLabel extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('IncomingShippingLabel', 'api/v1/incomingshippinglabel', incomingShippingLabelTemplate);
...
var IncomingShippingLabelController: any = new IncomingShippingLabel();
//----------------------------------------------------------------------------------------------