routes.push({
    pattern: /^reports\/salesinventoryreoderreport/, action: function (match: RegExpExecArray) {
        return RwSalesInventoryReorderReportController.getModuleScreen();
    }
});

var salesInventoryReorderFrontEnd = `
<div class="fwcontrol fwcontainer fwform fwreport salesinventoryreorderreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Invoice Summary" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="RwInventorySalesReorderReportController">
...
class RwSalesInventoryReorderClass extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('SalesInventoryReorderReport', 'api/v1/salesinventoryreoderreport', salesInventoryReorderFrontEnd);
