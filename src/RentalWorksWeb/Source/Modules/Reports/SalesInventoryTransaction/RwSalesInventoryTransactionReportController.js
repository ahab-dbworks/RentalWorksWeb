routes.push({
    pattern: /^reports\/salesinventorytransactionreport/, action: function (match) {
...
;
var RwSalesInventoryTransactionReportController = new RwSalesInventoryTransactionReportClass();
