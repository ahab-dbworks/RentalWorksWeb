routes.push({
    pattern: /^reports\/rentalinventoryqcrequiredreport/, action: function (match: RegExpExecArray) {
...
var RentalInventoryQCRequiredReportController: any = new RentalInventoryQCRequiredReport();