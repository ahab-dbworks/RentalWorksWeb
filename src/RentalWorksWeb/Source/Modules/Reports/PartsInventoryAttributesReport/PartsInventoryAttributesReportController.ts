routes.push({
    pattern: /^reports\/partsinventoryattributesreport/, action: function (match: RegExpExecArray) {
        return PartsInventoryAttributesReportController.getModuleScreen();
    }
});

const partsInventoryAttributesTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Parts Inventory Attributes Report" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="PartsInventoryAttributesReportController">
...
//----------------------------------------------------------------------------------------------
class PartsInventoryAttributesReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
...
var PartsInventoryAttributesReportController: any = new PartsInventoryAttributesReport();
//----------------------------------------------------------------------------------------------