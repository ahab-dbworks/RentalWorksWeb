routes.push({
    pattern: /^reports\/salesinventoryrepairhistoryreport/, action: function (match: RegExpExecArray) {
        return SalesInventoryRepairHistoryReportController.getModuleScreen();
    }
});

const salesEquipRepairHistReportTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Sales Inventory Repair History Report" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="SalesInventoryRepairHistoryReportController">
...
//----------------------------------------------------------------------------------------------
class SalesInventoryRepairHistoryReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('SalesInventoryRepairHistoryReport', 'api/v1/salesinventoryrepairhistoryreport', salesEquipRepairHistReportTemplate);
...
var SalesInventoryRepairHistoryReportController: any = new SalesInventoryRepairHistoryReport();