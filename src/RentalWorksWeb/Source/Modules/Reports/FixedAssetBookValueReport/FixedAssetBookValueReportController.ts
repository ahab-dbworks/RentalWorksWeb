routes.push({
    pattern: /^reports\/fixedassetbookvaluereport/, action: function (match: RegExpExecArray) {
        return FixedAssetBookValueReportController.getModuleScreen();
    }
});

const fixedAssetBookValueTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport fixedassetbookvalue" data-control="FwContainer" data-type="form" data-version="1" data-caption="Rental Inventory Value" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="FixedAssetBookValueReportController">
          ...
          <div class="row" style="display:flex;flex-wrap:wrap;">
            ...
            <div class="flexcolumn" style="max-width:600px;">
              <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Filters">
                <div class="fwcontrol fwcontainer fwform-fieldrow" data-control="FwContainer" data-type="fieldrow">
                  <div data-control="FwFormField" data-type="multiselectvalidation" class="fwcontrol fwformfield" data-caption="Purchase Warehouse" data-datafield="WarehouseId" data-displayfield="Warehouse" data-validationname="WarehouseValidation" data-showinactivemenu="true" style="float:left;min-width:400px;"></div>
                </div>
                <div class="fwcontrol fwcontainer fwform-fieldrow" data-control="FwContainer" data-type="fieldrow">
...
//----------------------------------------------------------------------------------------------
class FixedAssetBookValueReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('FixedAssetBookValueReport', 'api/v1/fixedassetbookvaluereport', fixedAssetBookValueTemplate);
...
var FixedAssetBookValueReportController: any = new FixedAssetBookValueReport();