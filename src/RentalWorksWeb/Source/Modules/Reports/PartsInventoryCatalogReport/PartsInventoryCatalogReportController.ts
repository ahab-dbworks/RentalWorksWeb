routes.push({
    pattern: /^reports\/partsinventorycatalogreport/, action: function (match: RegExpExecArray) {
        return PartsInventoryCatalogReportController.getModuleScreen();
    }
});

const partsInventoryCatalogTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Parts Inventory Catalog" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="PartsInventoryCatalogReportController">
...
`;
//----------------------------------------------------------------------------------------------
class PartsInventoryCatalogReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('PartsInventoryCatalogReport', 'api/v1/partsinventorycatalogreport', partsInventoryCatalogTemplate);
...
var PartsInventoryCatalogReportController: any = new PartsInventoryCatalogReport();