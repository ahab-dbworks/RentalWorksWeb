routes.push({
    pattern: /^reports\/creditsonaccountreport/, action: function (match) {
...
;
var RwCreditsOnAccountReportController = new RwCreditsOnAccountReport();
//# sourceMappingURL=RwCreditsOnAccountReportController.js.map