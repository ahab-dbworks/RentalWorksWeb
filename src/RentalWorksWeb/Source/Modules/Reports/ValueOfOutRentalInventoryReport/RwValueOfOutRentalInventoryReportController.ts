routes.push({
    pattern: /^reports\/valueofoutrentalinventoryreport/, action: function (match: RegExpExecArray) {
        return RwValueOfOutRentalInventoryReportController.getModuleScreen();
    }
});

const valueOfOutTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Value Of Out Rental Inventory Report" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="RwValueOfOutRentalInventoryReportController">
...
`;
//----------------------------------------------------------------------------------------------
class RwValueOfOutRentalInventoryReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
...
var RwValueOfOutRentalInventoryReportController: any = new RwValueOfOutRentalInventoryReport();