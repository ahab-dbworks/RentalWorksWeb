routes.push({
    pattern: /^reports\/returncontractreport/, action: function (match: RegExpExecArray) {
        return ReturnContractReportController.getModuleScreen();
    }
});

const returnContractReportTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="ReturnContractReportController">
      ...
      <div id="generaltabpage" class="tabpage" data-tabid="generaltab">
        <div class="formpage">
          <div class="formcolumn" style="width:260px">
            <div class="fwcontrol fwcontainer fwform-section" data-control="FwContainer" data-type="section" data-caption="Return Contract">
...
class ReturnContractReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('ReturnContractReport', 'api/v1/returncontractreport', returnContractReportTemplate);
...
var ReturnContractReportController: any = new ReturnContractReport();