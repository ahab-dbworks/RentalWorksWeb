routes.push({
    pattern: /^reports\/salesreport/, action: function (match: RegExpExecArray) {
        return RwSalesReportController.getModuleScreen();
    }
});

const salesReportTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Sales Report" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="RwSalesReportController">
...
//----------------------------------------------------------------------------------------------
class RwSalesReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
...
var RwSalesReportController: any = new RwSalesReport();