routes.push({
    pattern: /^reports\/repairorderreport/, action: function (match: RegExpExecArray) {
        return RepairOrderReportController.getModuleScreen();
    }
});

const repairOrderTemplate = `
<div class="fwcontrol fwcontainer fwform fwreport" data-control="FwContainer" data-type="form" data-version="1" data-caption="" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="RepairOrderReportController">
...
class RepairOrderReport extends FwWebApiReport {
    //----------------------------------------------------------------------------------------------
    constructor() {
        super('RepairOrderReport', 'api/v1/repairorderreport', repairOrderTemplate);
...
var RepairOrderReportController: any = new RepairOrderReport();