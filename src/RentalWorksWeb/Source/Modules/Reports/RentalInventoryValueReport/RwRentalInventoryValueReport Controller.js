routes.push({
    pattern: /^reports\/rentalinventoryvaluereport/, action: function (match) {
        return RwRentalInventoryValueReportController.getModuleScreen();
    }
});
var templateRentalInventoryValueFrontEnd = `
...
class RwRentalInventoryValueReport extends FwWebApiReport {
    constructor() {
        super('RentalInventoryValueReport', 'api/v1/rentalinventoryvaluereport', templateRentalInventoryValueFrontEnd);
...
;
var RwRentalInventoryValueReportController = new RwRentalInventoryValueReport();
//# sourceMappingURL=RwRentalInventoryValueReport Controller.js.map