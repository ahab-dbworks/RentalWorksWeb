...
<div class="fwcontrol fwcontainer fwform fwreport chargeprocessingexport" data-control="FwContainer" data-type="form" data-version="1" data-caption="Charge Processing - Invoices" data-rendermode="template" data-mode="" data-hasaudit="false" data-controller="ChargeProcessingController">
...
class RwChargeProcessingReport extends FwWebApiReport {
...
var RwChargeProcessingReportController = new RwChargeProcessingReport();
