class FacilityScheduleStatus {
    ...
    constructor() {
        this.Module = 'FacilityScheduleStatus';
        this.apiurl = 'api/v1/facilityschedulestatus';
    }
    ...
    loadAudit($form: any) {
        var uniqueid;
        uniqueid = $form.find('div.fwformfield[data-datafield="FacilityScheduleStatusId"] input').val();
