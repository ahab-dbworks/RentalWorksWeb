class UnretiredReason {
    ...
    loadForm(uniqueids: any) {
        ...
        $form.find('div.fwformfield[data-datafield="UnretiredReasonId"] input').val(uniqueids.UnretiredReasonId);
    ...
    loadAudit($form: any) {
        var uniqueid;
        uniqueid = $form.find('div.fwformfield[data-datafield="UnretiredReasonId"] input').val();
