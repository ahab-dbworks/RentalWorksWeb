class RwPOApprovalStatus {
    ...
    loadForm(uniqueids: any) {
        ...
        $form.find('div.fwformfield[data-datafield="PoApprovalStatusId"] input').val(uniqueids.PoApprovalStatusId);
    ...
    loadAudit($form: any) {
        var uniqueid;
        uniqueid = $form.find('div.fwformfield[data-datafield="PoApprovalStatusId"] input').val();
