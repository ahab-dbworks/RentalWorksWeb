...
//----------------------------------------------------------------------------------------------
//QuikSearch
FwApplicationTree.clickEvents[Constants.Grids.InventoryCompleteGrid.menuItems.QuikSearch.id] = function (e) {
    let search, $form, id;
    ...
    search.renderSearchPopup($form, id, 'Complete', gridInventoryType);
}
//----------------------------------------------------------------------------------------------