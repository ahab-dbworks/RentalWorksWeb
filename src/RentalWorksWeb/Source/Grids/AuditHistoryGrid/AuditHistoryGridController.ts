    ...
    generateRow($control, $generatedtr) {
        FwBrowse.setAfterRenderRowCallback($control, ($tr: JQuery, dt: FwJsonDataTable, rowIndex: number) => {
            ...
            html.push(`<ul style="font-size:14px; width:100%; display:flex;">
                                <span style="font-weight:bold; float:left; width:160px; text-decoration:underline; padding-right:1em;">Field Name</span>
            ...
            for (let i = 0; i < changes.length; i++) {
                html.push(`<ul style="font-size:14px; width:100%; display:flex;">
                                <span style="font-weight:bold; float:left; width:160px; padding-right:1em;">${changes[i].FieldName}:</span>
