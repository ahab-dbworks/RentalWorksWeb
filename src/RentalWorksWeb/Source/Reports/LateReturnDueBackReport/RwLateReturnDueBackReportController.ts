routes.push({ pattern: /^module\/latereturnduebackreport$/, action: function (match: RegExpExecArray) { return RwLateReturnDueBackReportController.getModuleScreen(); } });

class RwLateReturnDueBackReport {
    Module: string = 'LateReturnDueBackReport';
    ModuleOptions: any = {
        ReportOptions: {
