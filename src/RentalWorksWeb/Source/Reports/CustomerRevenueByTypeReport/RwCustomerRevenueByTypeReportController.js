routes.push({ pattern: /^module\/customerrevenuebytypereport$/, action: function (match) { return RwCustomerRevenueByTypeReportController.getModuleScreen(); } });
class RwCustomerRevenueByTypeReport {
    constructor() {
        this.Module = 'CustomerRevenueByTypeReport';
        this.ModuleOptions = {
            ReportOptions: {
