routes.push({ pattern: /^module\/projectmanagerbillingreport$/, action: function (match: RegExpExecArray) { return RwProjectManagerBillingReportController.getModuleScreen(); } });

class RwProjectManagerBillingReport {
    Module: string = 'ProjectManagerBillingReport';
    ModuleOptions: any = {
        ReportOptions: {
