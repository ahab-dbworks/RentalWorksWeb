routes.push({ pattern: /^module\/agentbillingreport$/, action: function (match: RegExpExecArray) { return RwAgentBillingReportController.getModuleScreen(); } });

class RwAgentBillingReport {
    Module: string = 'AgentBillingReport';
    ModuleOptions: any = {
        ReportOptions: {
...
var RwAgentBillingReportController: any = new RwAgentBillingReport();
