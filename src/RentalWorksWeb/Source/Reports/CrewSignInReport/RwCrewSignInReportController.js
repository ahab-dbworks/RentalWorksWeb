routes.push({ pattern: /^module\/crewsigninreport$/, action: function (match) { return RwCrewSignInReportController.getModuleScreen(); } });
class RwCrewSignInReport {
    constructor() {
        this.Module = 'CrewSignInReport';
        this.ModuleOptions = {
            ReportOptions: {
...
;
var RwCrewSignInReportController = new RwCrewSignInReport();
//# sourceMappingURL=RwCrewSignInReportController.js.map