routes.push({ pattern: /^module\/creditsonaccount$/, action: function (match: RegExpExecArray) { return RwCreditsOnAccountController.getModuleScreen(); } });

class RwCreditsOnAccount {
    Module: string = 'CreditsOnAccount';
    ModuleOptions: any = {
        ReportOptions: {
