...
//---------------------------------------------------------------------------------
//FwApplicationTree.clickEvents['{EC3921FE-3BF7-48E7-AD2F-EEB9BE8F9795}'] = function (event) {
//    let $form = jQuery(this).closest('.fwform');
...
//---------------------------------------------------------------------------------
//View Snapshot
//FwApplicationTree.clickEvents['{D68D49D7-9F04-4846-8A0C-C81F619D4942}'] = function (event) {
//    let $form = jQuery(this).closest('.fwform');
