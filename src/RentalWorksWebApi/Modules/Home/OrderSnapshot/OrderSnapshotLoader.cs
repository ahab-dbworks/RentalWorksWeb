...
{
    [FwSqlTable("snapshotview")]
    public class OrderSnapshotLoader : AppDataLoadRecord
    {
        //------------------------------------------------------------------------------------ 
        [FwSqlDataField(column: "snapshotid", modeltype: FwDataTypes.Text, isPrimaryKey: true)]
