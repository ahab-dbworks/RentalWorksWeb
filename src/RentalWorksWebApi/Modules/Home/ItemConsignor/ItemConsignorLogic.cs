...
{
    public class ItemConsignorLogic : RwBusinessLogic
    {
        //------------------------------------------------------------------------------------ 
        //ItemConsignorRecord itemConsignor = new ItemConsignorRecord();
        ItemConsignorLoader itemConsignorLoader = new ItemConsignorLoader();
        public ItemConsignorLogic()
        {
            //dataRecords.Add(itemConsignor);
            dataLoader = itemConsignorLoader;
        }
        //------------------------------------------------------------------------------------ 
