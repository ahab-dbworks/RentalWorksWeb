...
namespace WebApi.Modules.HomeControls.BillingSchedule
{
    internal class BillingScheduleService : IHostedService, IDisposable
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            b = BillingScheduleFunc.InitializeService(appConfig).Result;
        ...
        private void KeepFreshTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            try
            {
                ...
                bool b = BillingScheduleFunc.KeepAvailabilityCacheFresh(appConfig).Result;
            }
            finally
        ...
        private void CheckNeedRecalcTimer_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            try
            {
                ...
                bool b = BillingScheduleFunc.CheckNeedRecalc(appConfig).Result;
            }
            finally
            {
        ...
        {
            bool b = BillingScheduleFunc.InvalidateHourly(appConfig).Result;
        }
        //-------------------------------------------------------------------------------------------------------
        private void InvalidateDaily()
        {
            bool b = BillingScheduleFunc.InvalidateDaily(appConfig).Result;
        }
        //-------------------------------------------------------------------------------------------------------
