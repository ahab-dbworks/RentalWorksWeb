...
namespace WebApi.Modules.HomeControls.BillingSchedule
{
    ...
    public class TInventoryWarehouseAvailabilityRequestItem
    {
        ...
        public TInventoryWarehouseAvailabilityRequestItem(string inventoryId, string warehouseId, DateTime fromDateTime, DateTime toDateTime)
        {
            ...
            {
                toDateTime = BillingScheduleFunc.LateDateTime;
            }
    ...
    public class TInventoryWarehouseAvailability
    {
        ...
        public TInventoryWarehouseAvailabilityMinimum GetMinimumAvailableQuantity(DateTime fromDateTime, DateTime toDateTime, float additionalQuantity = 0)
        {
            ...
            DateTime currentAvailabilityDateTime = (InventoryWarehouse.HourlyAvailability ? BillingScheduleFunc.GetCurrentAvailabilityHour() : DateTime.Today);
            ...
            if (toDateTime.Equals(BillingScheduleFunc.LateDateTime))
            {
            ...
            else
            {
                ...
                if (!isStale)
                {
                    isStale = BillingScheduleFunc.InventoryWarehouseNeedsRecalc(InventoryWarehouse.InventoryId, InventoryWarehouse.WarehouseId);
                }
    ...
    public static class BillingScheduleFunc
    {
        ...
        public static async Task<bool> InitializeService(FwApplicationConfig appConfig)
        {
            ...
            {
                FwSqlCommand qry = new FwSqlCommand(conn, appConfig.DatabaseSettings.QueryTimeout);
                qry.Add("select needrecalcid = dod.orderid");
        ...
        //        qry.Add(" where t.sessionid = @sessionid ");
        //        qry.Add(" and   (");
        //        qry.Add("         (m.availfor not in ('" + RwConstants.INVENTORY_AVAILABLE_FOR_RENT + "','" + RwConstants.INVENTORY_AVAILABLE_FOR_SALE + "','" + RwConstants.INVENTORY_AVAILABLE_FOR_PARTS + "'))");
        //        qry.Add("           or");
        //        qry.Add("         (m.class = '" + RwConstants.INVENTORY_CLASSIFICATION_MISCELLAENOUS + "')");
        //        qry.Add("       )");
        //        qry.AddParameter("@sessionid", sessionId);
        //        await qry.ExecuteNonQueryAsync();
        //    }

        //    // check to see if the session has any items
        //    bool sessionHasItems = false;
        //    {
        //        FwSqlCommand qry = new FwSqlCommand(conn, appConfig.DatabaseSettings.QueryTimeout);
        //        qry.Add("select sessionhasitems = (case when exists (select * from tmpsearchsession t where t.sessionid = @sessionid) then 'T' else 'F' end) ");
        //        qry.Add(" option (recompile)  ");
        //        qry.AddParameter("@sessionid", sessionId);
        //        FwJsonDataTable dt = await qry.QueryToFwJsonTableAsync();

        //        sessionHasItems = FwConvert.ToBoolean(dt.Rows[0][dt.GetColumnNo("sessionhasitems")].ToString());
        //    }
        ...
        //            qryAcc.Add(" from  packagemasterwhforavail p                                         ");
        ...
        //                    {
        //                        reservation.ToDateTime = BillingScheduleFunc.LateDateTime;
        //                    }
        //                    else
        //                    {
        ...
        //                                    else
        //                                    {
        //                                        res.ToDateTime = BillingScheduleFunc.LateDateTime;
        //                                        res.Late = true;
        //                                    }
        //                                }
        ...
        //            {
        //                DateTime currentAvailabilityDateTime = (availData.InventoryWarehouse.HourlyAvailability ? BillingScheduleFunc.GetCurrentAvailabilityHour() : DateTime.Today);
        ...
        //    if (includeHours)
        //    {
        //        currentAvailabilityDateTime = BillingScheduleFunc.GetCurrentAvailabilityHour();
        //        if (request.FromDate < currentAvailabilityDateTime)
        //        {
        //            request.FromDate = currentAvailabilityDateTime;
        //        }
        ...
        //        TInventoryWarehouseAvailability availData = BillingScheduleFunc.GetAvailability(appConfig, userSession, inventoryId, warehouseId, fromDateTime, toDateTime, refreshIfNeeded, forceRefresh: false).Result;
        //        if (availData != null)
        //        {
