...
namespace WebApi.Modules.HomeControls.BillingSchedule
{
    ...
    public class BillingScheduleController : AppDataController
    {
        ...
        //[FwControllerMethod(Id: "Am5MEDEYuufs")]
        ...
        //    try
        //    {
        //        TInventoryAvailabilityCalendarAndScheduleResponse response = await BillingScheduleFunc.GetCalendarAndScheduleData(AppConfig, UserSession, request);
        ...
        //[HttpPost("conflicts")]
        //[FwControllerMethod(Id: "eY5YmgWshuPV", ActionType: FwControllerActionTypes.Browse)]
        ...
        //    try
        //    {
        //        AvailabilityConflictResponse response = await BillingScheduleFunc.GetConflicts(AppConfig, UserSession, request);
        //        return new OkObjectResult(response);
        //    }
        //    catch (Exception ex)
        //    {
