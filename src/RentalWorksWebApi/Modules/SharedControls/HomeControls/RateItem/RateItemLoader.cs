...
namespace WebApi.Modules.HomeControls.RateItem
{
    ...
    public class RateItemLoader : AppDataLoadRecord
    {
        //------------------------------------------------------------------------------------ 
        public RateItemLoader()
        {
        ...
        {
            get { return getClassificationColor(Classification); }
            set { }
        }
        //------------------------------------------------------------------------------------
        ...
        protected override void SetBaseSelectQuery(FwSqlSelect select, FwSqlCommand qry, FwCustomFields customFields = null, BrowseRequest request = null)
        {
            ...
            select.AddWhere("(availfor in ('" + RwConstants.RATE_AVAILABLE_FOR_MISC + "','" + RwConstants.RATE_AVAILABLE_FOR_LABOR + "'))"); 
        ...
        public void OnAfterBrowse(object sender, AfterBrowseEventArgs e)
        {
            if (e.DataTable != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        row[dt.GetColumnNo("ClassificationColor")] = getClassificationColor(row[dt.GetColumnNo("Classification")].ToString());
                    }
                }
            }
        }
