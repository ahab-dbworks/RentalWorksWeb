...
namespace WebApi.Modules.Warehouse.Contract
{
    ...
    public static class ContractFunc
    {
        ...
        //-------------------------------------------------------------------------------------------------------
        public static async Task<PurchaseOrderReceiveBarCodeAddItemsResponse> AddInventoryFromReceive(FwApplicationConfig appConfig, FwUserSession userSession, PurchaseOrderReceiveBarCodeAddItemsRequest request)
        {
        ...
        //------------------------------------------------------------------------------------------------------- 
        public static async Task<PurchaseOrderReceiveAssignBarCodesResponse> AssignBarCodesFromReceive(FwApplicationConfig appConfig, FwUserSession userSession, PurchaseOrderReceiveAssignBarCodesRequest request)
        {
