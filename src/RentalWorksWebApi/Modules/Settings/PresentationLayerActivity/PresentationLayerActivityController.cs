...
namespace RentalWorksWebApi.Modules.Settings.PresentationLayerActivity
{
    ...
    public class PresentationLayerActivityController : RwDataController
    {
        public PresentationLayerActivityController(IOptions<ApplicationConfig> appConfig) : base(appConfig) { }
        //------------------------------------------------------------------------------------ 
        ...
        {
            return await DoSaveFormAsync<PresentationLayerActivityLogic>(request, typeof(PresentationLayerActivityLogic));
        }
        //------------------------------------------------------------------------------------
