...
namespace RentalWorksWebApi.Controllers.v1
{
    ...
    public class OrganizationTypeController : RwDataController
    {
        public OrganizationTypeController(IOptions<ApplicationConfig> appConfig) : base(appConfig) { }
        //------------------------------------------------------------------------------------
        ...
        {
            return await DoGetAsync<OrganizationTypeLogic>(pageno, pagesize, typeof(OrganizationTypeLogic));
        }
        //------------------------------------------------------------------------------------
