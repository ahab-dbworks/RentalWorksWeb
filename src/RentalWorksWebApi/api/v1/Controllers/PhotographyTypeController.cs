...
namespace RentalWorksWebApi.Controllers.v1
{
    ...
    public class PhotographyTypeController : RwDataController
    {
        public PhotographyTypeController(IOptions<ApplicationConfig> appConfig) : base(appConfig) { }
        //------------------------------------------------------------------------------------
        ...
        {
            return await DoGetAsync<PhotographyTypeLogic>(pageno, pagesize, typeof(PhotographyTypeLogic));
        }
        //------------------------------------------------------------------------------------
