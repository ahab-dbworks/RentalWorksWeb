class InventoryRank {
    constructor() {
        ...
        this.caption = Constants.Modules.Settings.children.InventorySettings.children.InventoryRank.caption;
        this.nav = Constants.Modules.Settings.children.InventorySettings.children.InventoryRank.nav;
        this.id = Constants.Modules.Settings.children.InventorySettings.children.InventoryRank.id;
    }
    getModuleScreen() {
        var screen, $browse;
        screen = {};
...
//# sourceMappingURL=InventoryRank.js.map