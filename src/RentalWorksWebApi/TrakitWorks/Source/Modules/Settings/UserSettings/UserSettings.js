...
class UserSettings {
    ...
    openForm(mode) {
        let $form, $browsedefaultrows, $applicationtheme, $defaultHomePage, $moduleSelect, node, mainModules, settingsModules, modules, allModules;
        ...
        for (let i = 0; i < modules.length; i++) {
            ...
            let moduleGUID = modules[i].id, moduleCaption = modules[i].properties.caption, moduleController = modules[i].properties.controller;
