class POType {
    constructor() {
        ...
        this.caption = Constants.Modules.Settings.children.POSettings.children.POType.caption;
        this.nav = Constants.Modules.Settings.children.POSettings.children.POType.nav;
        this.id = Constants.Modules.Settings.children.POSettings.children.POType.id;
    }
    getModuleScreen() {
        var screen, $browse;
        screen = {};
...
//# sourceMappingURL=POType.js.map