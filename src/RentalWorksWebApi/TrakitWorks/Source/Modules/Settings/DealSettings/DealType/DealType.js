class DealType {
    constructor() {
        ...
        this.caption = Constants.Modules.Settings.children.DealSettings.children.DealType.caption;
        this.nav = Constants.Modules.Settings.children.DealSettings.children.DealType.nav;
        this.id = Constants.Modules.Settings.children.DealSettings.children.DealType.id;
    }
    getModuleScreen() {
        var screen, $browse;
        screen = {};
