class Warehouse {
    constructor() {
        ...
        this.caption = Constants.Modules.Settings.Warehouse.caption;
        this.nav = Constants.Modules.Settings.Warehouse.nav;
        this.id = Constants.Modules.Settings.Warehouse.id;
    }
    getModuleScreen() {
        var screen, $browse;
        screen = {};
