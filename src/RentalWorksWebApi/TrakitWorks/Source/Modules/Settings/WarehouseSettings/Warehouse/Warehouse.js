class Warehouse {
    constructor() {
        ...
        this.caption = Constants.Modules.Settings.children.WarehouseSettings.children.Warehouse.caption;
        this.nav = Constants.Modules.Settings.children.WarehouseSettings.children.Warehouse.nav;
        this.id = Constants.Modules.Settings.children.WarehouseSettings.children.Warehouse.id;
    }
