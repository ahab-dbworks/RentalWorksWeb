class CheckInBase {
    ...
    beforeValidateSpecificOrder($browse, $form, request) {
    ...
    events($form) {
        ...
        $form.find('.createcontract').on('click', e => {
            ...
            if (contractId) {
                FwAppData.apiMethod(true, 'POST', `${this.apiurl}/completecheckincontract/${contractId}`, null, FwServices.defaultTimeout, response => {
        ...
        $form.find('.orderstatus').on('click', e => {
            ...
            if (this.Module == 'TransferIn') {
                $orderStatusForm = window.TransferStatusController.openForm('EDIT', orderInfo);
...
//# sourceMappingURL=CheckInBase.js.map