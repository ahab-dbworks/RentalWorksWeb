...
class DuplicateRule {
    constructor() {
        ...
        this.caption = Constants.Modules.Administrator.children.DuplicateRule.caption;
        this.nav = Constants.Modules.Administrator.children.DuplicateRule.nav;
        this.id = Constants.Modules.Administrator.children.DuplicateRule.id;
