class EmailHistory {
    ...
    caption:            string = Constants.Modules.Administrator.children.EmailHistory.caption;
    nav:                string = Constants.Modules.Administrator.children.EmailHistory.nav;
    id:                 string = Constants.Modules.Administrator.children.EmailHistory.id;
