class User {
    constructor() {
        ...
        this.caption = Constants.Modules.Administrator.children.User.caption;
        this.nav = Constants.Modules.Administrator.children.User.nav;
        this.id = Constants.Modules.Administrator.children.User.id;
