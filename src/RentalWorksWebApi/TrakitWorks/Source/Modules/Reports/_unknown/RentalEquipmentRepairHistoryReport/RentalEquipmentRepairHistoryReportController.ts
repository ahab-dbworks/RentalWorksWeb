routes.push({
    pattern: /^reports\/rentalequipmentrepairhistoryreport/, action: function (match: RegExpExecArray) {
...
var RentalEquipmentRepairHistoryReportController: any = new RentalEquipmentRepairHistoryReport();