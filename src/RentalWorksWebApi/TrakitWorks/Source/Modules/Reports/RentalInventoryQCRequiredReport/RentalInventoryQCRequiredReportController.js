routes.push({
    pattern: /^reports\/rentalinventoryqcrequiredreport/,
    action: function (match) {
        return RentalInventoryQCRequiredReportController.getModuleScreen();
    }
});
...
`;
class RentalInventoryQCRequiredReport extends FwWebApiReport {
    constructor() {
...
;
var RentalInventoryQCRequiredReportController = new RentalInventoryQCRequiredReport();
//# sourceMappingURL=RentalInventoryQCRequiredReportController.js.map