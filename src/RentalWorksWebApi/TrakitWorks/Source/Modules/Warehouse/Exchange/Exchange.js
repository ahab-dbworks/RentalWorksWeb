class Exchange {
    constructor() {
        ...
        this.caption = Constants.Modules.Warehouse.children.Exchange.caption;
        this.nav = Constants.Modules.Warehouse.children.Exchange.nav;
        this.id = Constants.Modules.Warehouse.children.Exchange.id;
        this.ContractId = '';
    ...
    addFormMenuItems(options) {
        ...
        FwMenu.addSubMenuItem(options.$groupOptions, 'Cancel Exchange', '', (e) => {
            try {
    ...
    getSuspendedSessions($form) {
        ...
        if (showSuspendedSessions != "false") {
            FwAppData.apiMethod(true, 'GET', `api/v1/exchange/suspendedsessionsexist?warehouseId=${warehouse.warehouseid}`, null, FwServices.defaultTimeout, response => {
                if (response) {
