...
class DashboardSettings {
    constructor() {
        ...
        this.apiurl = 'api/v1/dashboardsettings';
        this.caption = Constants.Modules.Utilities.children.DashboardSettings.caption;
        this.nav = Constants.Modules.Utilities.children.DashboardSettings.nav;
        this.id = Constants.Modules.Utilities.children.DashboardSettings.id;
    }
    getModuleScreen() {
        var screen = {};
