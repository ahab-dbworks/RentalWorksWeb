routes.push({ pattern: /^module\/quikactivitycalendar$/, action: function (match) { return QuikActivityCalendarController.getModuleScreen(); } });
class QuikActivityCalendar {
    constructor() {
        this.Module = 'QuikActivityCalendar';
        this.caption = Constants.Modules.Utilities.children.QuikActivityCalendar.caption;
        this.nav = Constants.Modules.Utilities.children.QuikActivityCalendar.nav;
        this.id = Constants.Modules.Utilities.children.QuikActivityCalendar.id;
...
//# sourceMappingURL=QuikActivityCalendar.js.map