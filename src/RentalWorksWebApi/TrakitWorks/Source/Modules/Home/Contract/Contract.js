...
class Contract {
    constructor() {
        ...
        this.caption = Constants.Modules.Home.Contract.caption;
        this.nav = Constants.Modules.Home.Contract.nav;
        this.id = Constants.Modules.Home.Contract.id;
        ...
        this.addBrowseMenuItems = ($menuObject) => {
...
FwApplicationTree.clickEvents[Constants.Modules.Home.Contract.form.menuItems.PrintOrder.id] = function (e) {
    try {
