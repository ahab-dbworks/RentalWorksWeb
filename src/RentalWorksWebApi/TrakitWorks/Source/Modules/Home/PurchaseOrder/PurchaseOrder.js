...
class PurchaseOrder {
    constructor() {
        ...
        this.caption = Constants.Modules.Home.PurchaseOrder.caption;
        this.nav = Constants.Modules.Home.PurchaseOrder.nav;
        this.id = Constants.Modules.Home.PurchaseOrder.id;
