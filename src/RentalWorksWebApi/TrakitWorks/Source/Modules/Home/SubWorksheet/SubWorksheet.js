routes.push({ pattern: /^module\/subworksheet$/, action: function (match) { return SubWorksheetController.getModuleScreen(); } });
class SubWorksheet {
    constructor() {
        this.Module = 'SubWorksheet';
        this.caption = Constants.Modules.Home.children.SubWorksheet.caption;
        this.nav = Constants.Modules.Home.children.SubWorksheet.nav;
        this.id = Constants.Modules.Home.children.SubWorksheet.id;
    }
    getModuleScreen() {
        var screen = {};
...
//# sourceMappingURL=SubWorksheet.js.map