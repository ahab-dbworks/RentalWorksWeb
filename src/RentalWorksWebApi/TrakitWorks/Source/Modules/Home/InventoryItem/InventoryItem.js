...
class InventoryItem {
    constructor() {
        ...
        this.caption = Constants.Modules.Home.InventoryItem.caption;
        this.nav = Constants.Modules.Home.InventoryItem.nav;
        this.id = Constants.Modules.Home.InventoryItem.id;
        this.ActiveView = 'ALL';
        this.AvailableFor = 'X';
        this.yearData = [];
