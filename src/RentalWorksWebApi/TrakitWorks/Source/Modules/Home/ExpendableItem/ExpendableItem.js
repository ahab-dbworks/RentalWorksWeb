routes.push({ pattern: /^module\/expendableitem$/, action: function (match) { return ExpendableItemController.getModuleScreen(); } });
class ExpendableItem {
    constructor() {
        this.Module = 'ExpendableItem';
        this.apiurl = 'api/v1/salesinventory';
        this.caption = Constants.Modules.Home.children.ExpendableItem.caption;
        this.nav = Constants.Modules.Home.children.ExpendableItem.nav;
        this.id = Constants.Modules.Home.children.ExpendableItem.id;
        this.ActiveView = 'ALL';
        this.AvailableFor = 'X';
        this.yearData = [];
    ...
    addBrowseMenuItems($menuObject) {
        ...
        const $item = FwMenu.generateDropDownViewBtn('Item', true, "I");
        const $accessory = FwMenu.generateDropDownViewBtn('Accessory', false, "A");
        const $complete = FwMenu.generateDropDownViewBtn('Complete', false, "C");
        const $kit = FwMenu.generateDropDownViewBtn('Kit', false, "K");
        const $set = FwMenu.generateDropDownViewBtn('Set', false, "S");
        const $misc = FwMenu.generateDropDownViewBtn('Misc', false, "M");
        const $container = FwMenu.generateDropDownViewBtn('Container', false, "N");
...
//# sourceMappingURL=ExpendableItem.js.map