class Exchange {
    constructor() {
        ...
        this.caption = Constants.Modules.Home.Exchange.caption;
        this.nav = Constants.Modules.Home.Exchange.nav;
        this.id = Constants.Modules.Home.Exchange.id;
        this.ContractId = '';
    ...
    getSuspendedSessions($form) {
        ...
        if (showSuspendedSessions != "false") {
            FwAppData.apiMethod(true, 'GET', 'api/v1/exchange/suspendedsessionsexist', null, FwServices.defaultTimeout, response => {
