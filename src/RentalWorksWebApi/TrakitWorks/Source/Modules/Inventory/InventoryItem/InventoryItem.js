routes.push({ pattern: /^module\/inventoryitem$/, action: function (match) { return InventoryItemController.getModuleScreen(); } });
class InventoryItem {
    constructor() {
        this.Module = 'InventoryItem';
        this.apiurl = 'api/v1/rentalinventory';
        this.caption = Constants.Modules.Inventory.children.InventoryItem.caption;
        this.nav = Constants.Modules.Inventory.children.InventoryItem.nav;
        this.id = Constants.Modules.Inventory.children.InventoryItem.id;
        this.ActiveView = 'ALL';
        this.AvailableFor = 'X';
        this.yearData = [];
