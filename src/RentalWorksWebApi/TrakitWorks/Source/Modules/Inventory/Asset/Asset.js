...
class Asset {
    constructor() {
        ...
        this.caption = Constants.Modules.Inventory.children.Asset.caption;
        this.nav = Constants.Modules.Inventory.children.Asset.nav;
        this.id = Constants.Modules.Inventory.children.Asset.id;
