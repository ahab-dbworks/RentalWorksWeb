...
class Customer {
    constructor() {
        ...
        this.caption = Constants.Modules.Agent.children.Customer.caption;
        this.nav = Constants.Modules.Agent.children.Customer.nav;
        this.id = Constants.Modules.Agent.children.Customer.id;
    }
