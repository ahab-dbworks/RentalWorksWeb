//---------------------------------------------------------------------------------
class FwBasePagesClass {
    //---------------------------------------------------------------------------------
    getDefaultScreen (viewModel) {
        ...
        var screen: any = {};
        screen.$view = jQuery(<string>html);
    ...
    //---------------------------------------------------------------------------------
    getMobileLoginScreen (viewModel) {
    ...
    //---------------------------------------------------------------------------------
    getChangePasswordScreen(viewModel) {
...
var FwBasePages = new FwBasePagesClass();
