...
{
    public class SalesRepresentativeBillingReportLogic : AppBusinessLogic
    {
        //------------------------------------------------------------------------------------ 
        SalesRepresentativeBillingReportLoader salesRepresentativeBillingReportLoader = new SalesRepresentativeBillingReportLoader();
        public SalesRepresentativeBillingReportLogic()
        {
            dataLoader = salesRepresentativeBillingReportLoader;
        }
        //------------------------------------------------------------------------------------ 
