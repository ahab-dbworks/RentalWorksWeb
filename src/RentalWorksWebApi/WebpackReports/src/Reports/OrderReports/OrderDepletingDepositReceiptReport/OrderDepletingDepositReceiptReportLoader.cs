...
namespace WebApi.Modules.Reports.OrderDepletingDepositReceiptReport
{
    ...
    public class OrderDepletingDepositReceiptReportItemLoader : AppReportLoader
    {
        //------------------------------------------------------------------------------------ 
        ...
        //------------------------------------------------------------------------------------ 
        public async Task<List<OrderDepletingDepositReceiptReportItemLoader>> LoadItems(OrderDepletingDepositReceiptReportRequest request)
        {
            useWithNoLock = false;
            ...
            List<OrderDepletingDepositReceiptReportItemLoader> items = new List<OrderDepletingDepositReceiptReportItemLoader>();
            foreach (List<object> row in dt.Rows)
            {
                OrderDepletingDepositReceiptReportItemLoader item = (OrderDepletingDepositReceiptReportItemLoader)Activator.CreateInstance(typeof(OrderDepletingDepositReceiptReportItemLoader));
    ...
    public class OrderDepletingDepositReceiptReportLoader : AppReportLoader
    {
        ...
        //------------------------------------------------------------------------------------
        public List<OrderDepletingDepositReceiptReportItemLoader> Items { get; set; } = new List<OrderDepletingDepositReceiptReportItemLoader>(new OrderDepletingDepositReceiptReportItemLoader[] { new OrderDepletingDepositReceiptReportItemLoader() });
        //------------------------------------------------------------------------------------
        ...
        {
            OrderDepletingDepositReceiptReportLoader Order = null;
            useWithNoLock = false;
            using (FwSqlConnection conn = new FwSqlConnection(AppConfig.DatabaseSettings.ConnectionString))
            {
                ...
                using (FwSqlCommand qry = new FwSqlCommand(conn, "webgetorderprintheader", this.AppConfig.DatabaseSettings.ReportTimeout))
                {
                    ...
                    Task<OrderDepletingDepositReceiptReportLoader> taskOrder = qry.QueryToTypedObjectAsync<OrderDepletingDepositReceiptReportLoader>();
                    Order = taskOrder.Result;
                }

                //items
                Task<List<OrderDepletingDepositReceiptReportItemLoader>> taskItems;
                OrderDepletingDepositReceiptReportItemLoader Items = new OrderDepletingDepositReceiptReportItemLoader();
