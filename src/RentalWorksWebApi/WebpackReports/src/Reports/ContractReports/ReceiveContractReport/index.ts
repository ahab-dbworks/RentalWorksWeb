...
export class ReceiveContractReport extends WebpackReport {
        ...
        try {
            ...
            Ajax.get<DataTable>(`${apiUrl}/api/v1/logosettings/1`, authorizationHeader)
                .then((response: DataTable) => {
                    ...
                    Ajax.post<ReceiveContract>(`${apiUrl}/api/v1/receivecontractreport/runreport`, authorizationHeader, parameters)
                        .then((response: ReceiveContract) => {
    ...
    renderFooterHtml(model: ReceiveContract): string {
