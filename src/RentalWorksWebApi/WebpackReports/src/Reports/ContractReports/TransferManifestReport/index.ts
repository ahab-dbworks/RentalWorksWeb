...
export class TransferManifestReport extends WebpackReport {
    contract: TransferManifest = null;
        ...
        try {
            ...
            Ajax.get<DataTable>(`${apiUrl}/api/v1/logosettings/1`, authorizationHeader)
                .then((response: DataTable) => {
                    ...
                    Ajax.post<TransferManifest>(`${apiUrl}/api/v1/transfermanifestreport/runreport`, authorizationHeader, parameters)
                        .then((response: TransferManifest) => {
    ...
    renderFooterHtml(model: TransferManifest): string {
