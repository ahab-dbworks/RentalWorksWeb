...
export class ExchangeContractReport extends WebpackReport {
    contract: ExchangeContract = null;
    ...
    renderFooterHtml(model: ExchangeContract): string {
        this.footerHtml = hbFooter(model);
        return this.footerHtml;
    }
}

(<any>window).report = new ExchangeContractReport();
