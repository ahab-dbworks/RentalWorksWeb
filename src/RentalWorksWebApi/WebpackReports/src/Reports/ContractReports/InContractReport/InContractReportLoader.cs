...
namespace WebApi.Modules.Reports.ContractReports.InContractReport
{
    ...
    public class InContractReportLoader : OrderContractReportLoader
    {
        //------------------------------------------------------------------------------------ 
        public async Task<InContractReportLoader> RunReportAsync(InContractReportRequest request)
        {
            Task<InContractReportLoader> taskContract;
            InContractReportLoader Contract = null;
            ...
            using (FwSqlConnection conn = new FwSqlConnection(AppConfig.DatabaseSettings.ConnectionString))
            {
                ...
                using (FwSqlCommand qry = new FwSqlCommand(conn, AppConfig.DatabaseSettings.ReportTimeout))
                {
                    ...
                    taskContract = qry.QueryToTypedObjectAsync<InContractReportLoader>();
