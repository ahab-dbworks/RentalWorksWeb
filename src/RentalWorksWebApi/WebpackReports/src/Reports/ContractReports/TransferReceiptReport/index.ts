...
export class TransferReceiptReport extends WebpackReport {
    contract: TransferReceipt = null;
        ...
        try {
            ...
            Ajax.get<DataTable>(`${apiUrl}/api/v1/logosettings/1`, authorizationHeader)
                .then((response: DataTable) => {
                    ...
                    Ajax.post<TransferReceipt>(`${apiUrl}/api/v1/transferreceiptreport/runreport`, authorizationHeader, parameters)
    ...
    renderFooterHtml(model: TransferReceipt): string {
        this.footerHtml = hbFooter(model);
        return this.footerHtml;
    }
}

(<any>window).report = new TransferReceiptReport();
