...
export class SubRentalBillingAnalysisReport extends WebpackReport {
    renderReport(apiUrl: string, authorizationHeader: string, parameters: any): void {
        try {
            super.renderReport(apiUrl, authorizationHeader, parameters);
            Ajax.post<DataTable>(`${apiUrl}/api/v1/subrentalbillinganalysisreport/runreport`, authorizationHeader, parameters)
...
(<any>window).report = new SubRentalBillingAnalysisReport();