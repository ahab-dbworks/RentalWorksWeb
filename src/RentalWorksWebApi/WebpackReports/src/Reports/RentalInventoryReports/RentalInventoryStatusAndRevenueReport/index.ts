...
export class RentalInventoryStatusAndRevenueReport extends WebpackReport {
    renderReport(apiUrl: string, authorizationHeader: string, parameters: any): void {
        try {
            super.renderReport(apiUrl, authorizationHeader, parameters);
            Ajax.post<DataTable>(`${apiUrl}/api/v1/rentalinventorystatusandrevenuereport/runreport`, authorizationHeader, parameters)
...
(<any>window).report = new RentalInventoryStatusAndRevenueReport();