...
{
    public class ProjectManagerBillingReportLogic : AppBusinessLogic
    {
        //------------------------------------------------------------------------------------ 
        ProjectManagerBillingReportLoader projectManagerBillingReportLoader = new ProjectManagerBillingReportLoader();
        public ProjectManagerBillingReportLogic()
        {
            dataLoader = projectManagerBillingReportLoader;
        }
        //------------------------------------------------------------------------------------ 
