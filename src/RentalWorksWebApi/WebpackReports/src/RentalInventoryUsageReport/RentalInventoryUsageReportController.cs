...
namespace WebApi.Modules.Reports.RentalInventoryUsageReport
{
    ...
    {
        public RentalInventoryUsageReportController(IOptions<FwApplicationConfig> appConfig) : base(appConfig) { }
        ...
        //------------------------------------------------------------------------------------ 
        // POST api/v1/rentalinventoryusagereport/exportexcelxlsx/filedownloadname 
