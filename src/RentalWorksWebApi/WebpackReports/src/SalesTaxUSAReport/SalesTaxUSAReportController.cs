...
{
    public class SalesTaxUSAReportRequest : AppReportRequest
    {
    ...
    public class SalesTaxUSAReportController : AppReportController
    {
        ...
        public async Task<ActionResult<DoExportExcelXlsxExportFileAsyncResult>> ExportExcelXlsxFileAsync([FromBody]SalesTaxUSAReportRequest request)
        {
        ...
        public async Task<ActionResult<FwJsonDataTable>> RunReportAsync([FromBody]SalesTaxUSAReportRequest request)
        {
