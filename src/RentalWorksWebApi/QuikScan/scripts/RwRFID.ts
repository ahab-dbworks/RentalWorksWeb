class RwRFIDClass {
    ...
    isTslPerformingSoftwareDoublePress: boolean = false;
    zebraTriggerMode: string = 'BARCODE';
    isRFIDAPI3: boolean = false;
    isTsl: boolean = false;
    //----------------------------------------------------------------------------------------------
    init() {
    ...
    //----------------------------------------------------------------------------------------------
    registerRFIDEvents(callbackfunction) {
        var me = this;
        if (typeof window.TslReader !== 'undefined') {
                ...
                switch (keyCode) {
                    ...
                    case "MC33-P2":
                        if (jQuery('.fwcontextmenu').length > 0) {
                            ...
                            RwRFID.setZebraRFIDAPI3PowerLevel();
                        }
                        break;
                }
            });
    ...
    //----------------------------------------------------------------------------------------------
    updateTagFinderNotification(tag, distance) {
    ...
    //----------------------------------------------------------------------------------------------
    hideRFIDNotification() {
        jQuery('.rfid-notification').remove();
    }
    //----------------------------------------------------------------------------------------------
    showRFIDNotification(text, autoHide) {
        RwRFID.hideRFIDNotification();
    ...
    //----------------------------------------------------------------------------------------------
    setZebraRFIDAPI3PowerLevel() {
        if (typeof window.ZebraRFIDAPI3 !== 'undefined' && typeof window.ZebraRFIDAPI3.getPowerLevel === 'function') {
