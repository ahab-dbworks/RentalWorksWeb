...
namespace QuartzScheduler.Server
{
    ...
    public class Configuration
	{
		...
		private const string DefaultServiceName = Constants.AppName + "QuartzServer";
		private const string DefaultServiceDisplayName = Constants.AppName + " Quartz Server";
		private const string DefaultServiceDescription = Constants.AppName + " Quartz Job Scheduling Server";
