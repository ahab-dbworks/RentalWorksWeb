        ...
        public static void ModuleRouting(dynamic request, dynamic response, dynamic session)
        {
            ...
            switch(componentType)
            {
                case "Module":
                    ...
                    type = typeof(RwService).Assembly.GetType("RwQBO.Source.Modules." + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwModule))))
                    {
                        FwModule module = (FwModule)Activator.CreateInstance(type);
                        module.Init("RwQBO.Source", "", typeof(RwService).Assembly, request, response, session);
                        if (module != null)
                        {
                ...
                case "Grid":
                    ...
                    type = typeof(RwService).Assembly.GetType("RwQBO.Source.Grids." + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwGrid))))
                    {
                        FwGrid grid = (FwGrid)Activator.CreateInstance(type);
                        grid.Init("RwQBO.Source", "", typeof(RwService).Assembly, request, response, session);
                        if (grid != null)
                        {
                ...
                case "Validation":
                    ...
                    type = typeof(RwService).Assembly.GetType("RwQBO.Source.Validations." + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwValidation))))
                    {
                        FwValidation validation = (FwValidation)Activator.CreateInstance(type);
                        validation.Init("RwQBO.Source", "", typeof(RwService).Assembly, request, response, session);
                        if (validation != null)
                        {
                ...
                case "Reports":
                    ...
                    type = typeof(RwService).Assembly.GetType("RwQBO.Source.Reports." + name, false);
