...
namespace RwQBO
{
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksQuikScanTree(FwSecurityTreeNode system)
        {
            ...
            var application = AddApplication("RentalWorks QuikScan", "{8D0A5ECF-72D2-4428-BDC8-7E3CC56EDD3A}", system.Id);
            var lv1menuHome = AddLv1ModuleMenu("Home", "{512418CD-7977-4B7A-B773-F7FC0A05397C}", application.Id);
