var FwFormField_checkboxlistClass = (function () {
    function FwFormField_checkboxlistClass() {
    }
    FwFormField_checkboxlistClass.prototype.renderDesignerHtml = function ($control, html) {
    };
    FwFormField_checkboxlistClass.prototype.renderRuntimeHtml = function ($control, html) {
        var options = {};
    ...
    FwFormField_checkboxlistClass.prototype.loadItems = function ($control, items, hideEmptyItem) {
    ...
    FwFormField_checkboxlistClass.prototype.loadForm = function ($fwformfield, table, field, value, text) {
        var html, hasorderby, checkboxid;
        html = [];
        if ((typeof value !== 'undefined') && (value !== null)) {
            for (var i = 0; i < value.length; i++) {
                ...
                if (typeof value[i].orderbydirection !== 'string')
                    value[i].orderbydirection = '';
                html.push('<li data-value="');
    ...
    FwFormField_checkboxlistClass.prototype.disable = function ($control) {
    };
    FwFormField_checkboxlistClass.prototype.enable = function ($control) {
    };
    FwFormField_checkboxlistClass.prototype.getValue2 = function ($fwformfield) {
        var value = [];
    ...
    FwFormField_checkboxlistClass.prototype.setValue = function ($fwformfield, value, text, firechangeevent) {
        var $inputvalue = $fwformfield.find('.fwformfield-value');
        $inputvalue.val(value);
        if (firechangeevent)
            $inputvalue.change();
    };
    return FwFormField_checkboxlistClass;
}());
var FwFormField_checkboxlist = new FwFormField_checkboxlistClass();
//# sourceMappingURL=FwFormField_checkboxlist.js.map