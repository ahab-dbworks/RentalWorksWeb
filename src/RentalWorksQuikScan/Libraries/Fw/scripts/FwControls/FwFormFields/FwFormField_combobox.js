var FwFormField_comboboxClass = (function () {
    function FwFormField_comboboxClass() {
    }
    FwFormField_comboboxClass.prototype.renderDesignerHtml = function ($control, html) {
    ...
    FwFormField_comboboxClass.prototype.renderRuntimeHtml = function ($control, html) {
    ...
    FwFormField_comboboxClass.prototype.loadItems = function ($control, items, hideEmptyItem) {
    };
    FwFormField_comboboxClass.prototype.loadForm = function ($fwformfield, table, field, value, text) {
        $fwformfield
    ...
    FwFormField_comboboxClass.prototype.disable = function ($control) {
        $control.find('.btnvalidate').attr('data-enabled', 'false');
        $control.find('.fwformfield-text').prop('disabled', true);
    };
    FwFormField_comboboxClass.prototype.enable = function ($control) {
        $control.find('.btnvalidate').attr('data-enabled', 'true');
        $control.find('.fwformfield-text').prop('disabled', false);
    };
    FwFormField_comboboxClass.prototype.getValue2 = function ($fwformfield) {
        var value = $fwformfield.find('.fwformfield-value').val();
        return value;
    };
    FwFormField_comboboxClass.prototype.getText2 = function ($fwformfield) {
        var text = $fwformfield.find('.fwformfield-text').val();
        return text;
    };
    FwFormField_comboboxClass.prototype.setValue = function ($fwformfield, value, text, firechangeevent) {
    ...
    FwFormField_comboboxClass.prototype.initControl = function ($control) {
    ...
    FwFormField_comboboxClass.prototype.databindcallback = function ($control, $browse, dt, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, controller) {
            ...
            $pager.find('.btnNextPage')
                ...
                try {
                    ...
                    if ($btnNextPage.attr('data-enabled') === 'true') {
                        var pageno = parseInt($pager.find('.txtPageNo').val()) + 1;
                        var totalPages = parseInt($pager.find('.txtTotalPages').html());
                        pageno = (pageno <= totalPages) ? pageno : totalPages;
                        $validationbrowse.attr('data-pageno', pageno.toString());
                        FwBrowse.databind($validationbrowse);
                    }
    ...
    FwFormField_comboboxClass.prototype.closeDropDown = function ($control, showAnimation) {
    ...
    FwFormField_comboboxClass.prototype.validate = function ($control, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, useSearchFieldValue) {
    ...
    FwFormField_comboboxClass.prototype.selectRow = function ($control, $row, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, controller) {
        FwFormField_combobox.highlightRow($control, $row);
        ...
        FwFormField_combobox.clearSearchCriteria($validationbrowse);
        FwFormField_combobox.closeDropDown($control, true);
        var originalcolor = $searchfield.css('background-color');
    ...
    FwFormField_comboboxClass.prototype.clearSearchCriteria = function ($validationbrowse) {
    ...
    FwFormField_comboboxClass.prototype.getHighlightedRow = function ($control) {
        var $row = null;
        if ($control.data('dropdown') !== null) {
    ...
    FwFormField_comboboxClass.prototype.highlightRow = function ($control, $row) {
        if (($control.data('dropdown') !== null) && (typeof $row !== 'undefined') && ($row.length > 0)) {
            $control.data('dropdown').find('.row').removeClass('selected');
            $row.addClass('selected');
        }
    };
    FwFormField_comboboxClass.prototype.highlightNextRow = function ($control) {
    ...
    FwFormField_comboboxClass.prototype.highlightPrevRow = function ($control) {
        var $row = FwFormField_combobox.getHighlightedRow($control);
        if ($row !== null) {
    ...
    return FwFormField_comboboxClass;
}());
