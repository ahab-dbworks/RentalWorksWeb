        ...
        if ((typeof reportOptions.HasEmailPdf === 'undefined') || (reportOptions.HasEmailPdf === true)) {
            ...
            $btnEmailPdf.on('click', (event) => {
                try {
                    ...
                    $confirmation.on('change', '[data-datafield="tousers"] .fwformfield-value', (event) => {
                        let requestGetEmailByWebUsersId = {};
                        ...
                        FwAppData.apiMethod(true, 'POST', this.apiurl + '/getemailbywebusersid', requestGetEmailByWebUsersId, timeout, (successResponse) => {
                            try {
                    ...
                    $confirmation.on('change', '[data-datafield="ccusers"] .fwformfield-value', (event) => {
