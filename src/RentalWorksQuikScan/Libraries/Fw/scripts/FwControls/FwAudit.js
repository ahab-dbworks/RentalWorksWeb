var FwAuditClass = (function () {
    function FwAuditClass() {
        this.renderTemplateHtml = function ($control) {
    ...
    FwAuditClass.prototype.init = function ($control) {
    };
    FwAuditClass.prototype.getHtmlTag = function (data_type) {
    ...
    FwAuditClass.prototype.getDesignerProperties = function () {
        var properties = [], propId, propClass, propDataControl, propDataType, propDataVersion, data_type = '';
    ...
    FwAuditClass.prototype.renderDesignerHtml = function ($control) {
    ...
    FwAuditClass.prototype.renderRuntimeHtml = function ($control) {
    ...
    FwAuditClass.prototype.loadAudit = function ($form, uniqueid) {
...
var FwAudit = new FwAuditClass();
//# sourceMappingURL=FwAudit.js.map