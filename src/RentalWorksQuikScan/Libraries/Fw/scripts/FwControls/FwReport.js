var FwReportClass = (function () {
    ...
    FwReportClass.prototype.getFrontEnd = function (projectprefix, reportname, templateName) {
        ...
        if (typeof templateHtml === 'undefined')
            throw 'Unable to find template: ' + templateName + '.  A common way for this to happen is if the "Module" property on the Report Controller is incorrect.';
        html = [];
    ...
    FwReportClass.prototype.load = function ($form, reportOptions) {
        ...
        stylesheetcodemirror = window.CodeMirror.fromTextArea($form.find('.stylesheetcodemirror')[0], {
            mode: 'css',
            lineNumbers: true
        });
        ...
        headercodemirror = window.CodeMirror.fromTextArea($form.find('.headercodemirror')[0], {
            mode: 'htmlembeded',
            lineNumbers: true
        });
        ...
        bodycodemirror = window.CodeMirror.fromTextArea($form.find('.bodycodemirror')[0], {
            mode: 'htmlembeded',
            lineNumbers: true
        });
        ...
        footercodemirror = window.CodeMirror.fromTextArea($form.find('.footercodemirror')[0], {
            mode: 'htmlembeded',
            lineNumbers: true
        });
        ...
        if ((typeof reportOptions.HasExportHtml === 'undefined') || (reportOptions.HasExportHtml === true)) {
            ...
            $btnPreview.on('click', function (event) {
                ...
                try {
                    ...
                    FwAppData.jsonPost(true, webserviceurl, request, timeout, function (response) {
                        var win;
                        try {
                        ...
                        try {
                            ...
                            $btnSend.click(function (event) {
                                ...
                                try {
                                    ...
                                    webserviceurl = 'services.ashx?path=/reports/' + $form.attr('data-reportname') + '/SendPdfEmail';
                                    FwAppData.jsonPost(true, webserviceurl, requestSendPdfEmail, FwServices.defaultTimeout, function (response) {
                                        try {
                                            FwNotification.renderNotification('SUCCESS', 'Email Sent');
                                        }
                                        catch (ex) {
