var FwTabsClass = (function () {
    function FwTabsClass() {
    }
    FwTabsClass.prototype.upgrade = function ($control) {
    ...
    FwTabsClass.prototype.init = function ($control) {
    ...
    ;
    FwTabsClass.prototype.setActiveTab = function ($control, $tab) {
    ...
    ;
    FwTabsClass.prototype.getHtmlTag = function (data_type) {
    ...
    ;
    FwTabsClass.prototype.getDesignerProperties = function (data_type) {
    ...
    ;
    FwTabsClass.prototype.renderDesignerHtml = function ($control) {
    ...
    ;
    FwTabsClass.prototype.renderRuntimeHtml = function ($control) {
        ...
        $tabsChildren
            .each(function (index, tab) {
            var $tab, tabHtml, tabcolor, newtabids = {};
            $tab = jQuery(tab);
            $tab.empty();
    ...
    ;
    FwTabsClass.prototype.renderTemplateHtml = function ($control) {
    ...
    ;
    FwTabsClass.prototype.addTab = function ($control, caption, hasClose, tabType, setActive) {
    ...
    ;
    FwTabsClass.prototype.removeTab = function ($tab) {
    ...
    ;
    FwTabsClass.prototype.removeTabBySelector = function ($control, tabselector) {
        var $tab;
        $tab = $control.find(tabselector);
        FwTabs.removeTab($tab);
    };
    ;
    FwTabsClass.prototype.closeTabs = function ($control) {
        var $tabs, $tabpages;
    ...
    ;
    FwTabsClass.prototype.getTabPageByElement = function ($element) {
        var $tabpage;
        $tabpage = $element.closest('.tabpage');
        return $tabpage;
    };
    ;
    FwTabsClass.prototype.getTabByElement = function ($element) {
    ...
    ;
    FwTabsClass.prototype.getTabsByTab = function ($tab) {
        var $elementtab, $tabs;
        $tabs = $tab.closest('.tabs').find('.tab');
        return $tabs;
    };
    ;
    FwTabsClass.prototype.getTabByCaption = function ($element, tabcaption) {
    ...
    ;
    FwTabsClass.prototype.getTabPageByTab = function ($tab) {
    ...
    ;
    FwTabsClass.prototype.disableTab = function ($tab) {
        $tab.attr('data-enabled', 'false');
    };
    ;
    FwTabsClass.prototype.enableTab = function ($tab) {
        $tab.removeAttr('data-enabled');
    };
    ;
    FwTabsClass.prototype.showTab = function ($tab) {
        $tab.removeAttr('data-tabdisplay');
        $tab.removeAttr('data-enabled');
    };
    ;
    FwTabsClass.prototype.hideTab = function ($tab) {
