var FwSchedulerClass = (function () {
    function FwSchedulerClass() {
    }
    FwSchedulerClass.prototype.renderRuntimeHtml = function ($control) {
        var html, $daypilotcontrol, dp, nav, navcalendarid, dpcalendarid, navmonthid, nav5weekid, dpmonthid, dp5weekid, dpyearid, navschedulerid, dpschedulerid, viewCount, schedulerbtns, $schedulerbtns, $calendarmenu, $menucontrol, $form, controller;
        ...
        viewCount = 0;
        if ($control.attr('data-hidedayview') != 'true')
            viewCount++;
        if ($control.attr('data-hideweekview') != 'true')
            viewCount++;
        if ($control.attr('data-hidemonthview') != 'true')
            viewCount++;
        if ($control.attr('data-hideyearview') != 'true')
            viewCount++;
        if ($control.attr('data-showeventview') == 'true')
            viewCount++;
    ...
    ;
    FwSchedulerClass.prototype.init = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.loadControl = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.loadNavCalendar = function ($control) {
        var navcalendar;
    ...
    ;
    FwSchedulerClass.prototype.loadNav5Week = function ($control) {
        var nav5week;
    ...
    ;
    FwSchedulerClass.prototype.loadNavMonth = function ($control) {
        var navmonth;
    ...
    ;
    FwSchedulerClass.prototype.loadNavScheduler = function ($control) {
        var navscheduler;
    ...
    ;
    FwSchedulerClass.prototype.loadCalendar = function ($control) {
        var dpcalendar;
    ...
    ;
    FwSchedulerClass.prototype.loadMonth = function ($control) {
        var dpmonth;
        ...
        if (typeof $control.data('ontimerangedoubleclicked') === 'function')
            dpmonth.onTimeRangeDoubleClicked = $control.data('ontimerangedoubleclicked');
    ...
    ;
    FwSchedulerClass.prototype.load5Week = function ($control) {
        var dp5week;
    ...
    ;
    FwSchedulerClass.prototype.loadYear = function ($control) {
        var dpyear;
    ...
    ;
    FwSchedulerClass.prototype.loadScheduler = function ($control) {
        var dpscheduler;
    ...
    ;
    FwSchedulerClass.prototype.navigate = function ($control, date) {
    ...
    ;
    FwSchedulerClass.prototype.showDayView = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.showWeekView = function ($control) {
        var navcalendar, dpcalendar, selectedstartdate;
        navcalendar = $control.data('navcalendar');
    ...
    ;
    FwSchedulerClass.prototype.show5WeekView = function ($control) {
        var navcalendar, dpcalendar, selectedstartdate;
        navcalendar = $control.data('navcalendar');
        navcalendar.selectMode = "week";
        navcalendar.update();
    ...
    ;
    FwSchedulerClass.prototype.showMonthView = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.showYearView = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.showScheduleView = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.refresh = function ($control) {
        FwScheduler.loadEvents($control);
    };
    ;
    FwSchedulerClass.prototype.loadEvents = function ($control) {
        ...
        if (typeof $control.data('ongetevents') === 'function') {
            ...
            switch ($control.find('div.changeview[data-selected="true"]').html()) {
                ...
                case 'Month':
                    ...
                    days = dpmonth.days + dpmonth.startDate.dayOfWeek() + (6 - dpmonth.startDate.addDays(dpmonth.days).dayOfWeek());
                    break;
                case 'Year':
                    start = dpmonth.startDate.addDays(-dpmonth.startDate.dayOfWeek());
                    days = dpmonth.days + dpmonth.startDate.dayOfWeek() + (6 - dpmonth.startDate.addDays(dpmonth.days).dayOfWeek());
    ...
    ;
    FwSchedulerClass.prototype.loadEventsCallback = function ($control, resources, events) {
    ...
    ;
    FwSchedulerClass.prototype.loadYearEventsCallback = function ($control, resources, events) {
    ...
    ;
    FwSchedulerClass.prototype.getSelectedTimeRange = function ($control) {
        var result, dpmonth;
        result = {
    ...
    ;
    FwSchedulerClass.prototype.getSelectedDay = function ($control) {
        var result;
        result = $control.data('selectedstartdate');
        return result;
    };
    ;
    FwSchedulerClass.prototype.setSelectedTimeRange = function ($control, start, end) {
    ...
    ;
    FwSchedulerClass.prototype.setSelectedDay = function ($control, date) {
        var start, end;
        if (typeof date === 'string') {
    ...
    ;
    FwSchedulerClass.prototype.setDateCallout = function ($control, date) {
    ...
    ;
    FwSchedulerClass.prototype.addEvent = function ($control, evt) {
        var dpcalendar, dpmonth, dpscheduler, e, action;
        dpcalendar = $control.data('dpcalendar');
        dpmonth = $control.data('dpmonth');
        dpscheduler = $control.data('dpscheduler');
    ...
    FwSchedulerClass.prototype.addButtonMenuItem = function ($control, classname, text, onclick) {
        var $menu, $menuitem;
    ...
    FwSchedulerClass.prototype.load = function ($control) {
    ...
    ;
    FwSchedulerClass.prototype.getTodaysDate = function () {
        return new DayPilot.Date(new Date().toISOString());
    };
    FwSchedulerClass.prototype.getFirstSundayMonth = function (year) {
        for (var i = 0; i < 12; i++) {
    ...
    return FwSchedulerClass;
}());
var FwScheduler = new FwSchedulerClass();
//# sourceMappingURL=FwScheduler.js.map