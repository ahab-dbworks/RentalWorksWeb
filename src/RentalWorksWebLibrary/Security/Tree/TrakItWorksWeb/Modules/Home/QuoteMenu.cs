...
namespace WebLibrary.Security.Tree.TrakitWorksWeb.Modules.Settings
{
    public class QuoteMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddSubMenuItem("Cancel / Uncancel", "{86412C14-9351-4C03-8D13-5338AB0EAEC8}", nodeBrowseExport.Id);
            ...
            tree.AddSubMenuItem("Copy Quote", "{85B7FD07-74CD-4320-AFB0-9718EE5C8CDD}", nodeFormOptions.Id);
            ...
            tree.AddSubMenuItem("Print Quote", "{CC3F3DB4-21A4-4E70-8992-30886B2D1515}", nodeFormOptions.Id);
