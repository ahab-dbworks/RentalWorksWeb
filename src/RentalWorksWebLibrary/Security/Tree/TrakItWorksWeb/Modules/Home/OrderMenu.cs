...
namespace WebLibrary.Security.Tree.TrakItWorksWeb.Modules.Settings
{
    public class OrderMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddSubMenuItem("Cancel / Uncancel", "{CCD05127-481F-4352-A706-FEC6575DBEAF}", nodeBrowseExport.Id);
            ...
            tree.AddSubMenuItem("Search", "{0C8F88D0-F945-4B95-9E91-8704B2D04C30}", nodeFormOptions.Id);
