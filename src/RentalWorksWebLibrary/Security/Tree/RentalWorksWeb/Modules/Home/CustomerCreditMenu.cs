...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Modules.Settings
{
    public class CustomerCreditMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddNewMenuBarButton("{23A72586-F215-4F10-8F57-04A6D745F54B}", nodeBrowseMenuBar.Id);
            tree.AddViewMenuBarButton("{D4D1AA0A-B8F6-4C2C-A2AC-CA0D16C9A58C}", nodeBrowseMenuBar.Id);
            tree.AddEditMenuBarButton("{9B71070F-806E-48DC-9E14-0CBB888645FD}", nodeBrowseMenuBar.Id);
            tree.AddDeleteMenuBarButton("{AE063B29-B015-44AA-8010-EE1E29236E7F}", nodeBrowseMenuBar.Id);
        }
        //---------------------------------------------------------------------------------------------
    }
}