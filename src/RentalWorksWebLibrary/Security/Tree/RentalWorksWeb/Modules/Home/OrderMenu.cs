...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Modules
{
    public class OrderMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            //tree.AddSubMenuItem("Retire Loss & Damage", "{78ED6DE2-D2A2-4D0D-B4A6-16F1C928C412}", nodeFormOptions.Id);
            ...
            //tree.AddSubMenuItem("Cancel Snapshot", "{AB1D12DC-40F6-4DF2-B405-54A0C73149EA}", nodeFormOptions.Id);
            ...
            tree.AddSubMenuItem("Put On / Remove Hold", "{00AB18C2-221A-46F9-86DC-A7145D13A0D8}", nodeFormOptions.Id);
