...
namespace RentalWorksWebLibrary.Security.Tree.RentalWorksWeb.Modules.Settings
{
    public class GlDistributionMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddDownloadExcelSubMenuItem("{2C156DE0-C929-4F2D-AFA3-DF98D1839957}", nodeBrowseExport.Id);
            tree.AddNewMenuBarButton("{2322C04D-EE0F-428B-8CE8-27C1020D14B2}", nodeBrowseMenuBar.Id);
            ...
            tree.AddDeleteMenuBarButton("{9331D6E6-8CF4-4DA8-BCA9-D510DA7A4DF2}", nodeBrowseMenuBar.Id);
