...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Grids
{
    public class OrderPickListGridMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddDownloadExcelSubMenuItem("{71ECEBA6-2546-4B37-A455-987F910EC3CD}", nodeBrowseOptions.Id);
            tree.AddSubMenuItem("Print Pick List", "{EE96992B-47EB-4F4B-A91A-AC9B7138D03B}", nodeBrowseOptions.Id);
