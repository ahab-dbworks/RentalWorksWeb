...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Grids
{
    class OrderItemGrid : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            var nodeWorksheetMenu = tree.AddSubMenuGroup("Worksheet", "{484A7841-22BE-45FE-9F78-29491EF1AD86}", nodeGridSubMenu.Id);
            ...
            tree.AddSubMenuItem("Sub Worksheet", "{007C4F21-7526-437C-AD1C-4BBB1030AABA}", nodeWorksheetMenu.Id);
