...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Grids
{
    public class InventoryCompatibilityGridMenu : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            var nodeGridSubMenu = tree.AddSubMenu("{E38C60E4-30D3-4138-B575-51DC3D2BF54F}", nodeGridMenuBar.Id);
            var nodeBrowseOptions = tree.AddSubMenuGroup("Options", "{4A6D6AFD-0FD7-4996-825D-B58179113E94}", nodeGridSubMenu.Id);
            tree.AddDownloadExcelSubMenuItem("{74AACDC0-8D11-4351-822D-0173472FEDA7}", nodeBrowseOptions.Id);
