...
namespace WebLibrary.Security.Tree.RentalWorksWeb.Grids
{
    class InvoiceItemGrid : FwSecurityTreeBranch
    {
        ...
        public override void BuildBranch(FwSecurityTree tree)
        {
            ...
            tree.AddSubMenuItem("Summary View", "{46D27E42-9C66-42F5-922C-CAE617856F63}", nodeBrowseOptions.Id);
            tree.AddSubMenuItem("Search", "{57716A0E-7541-48F4-B0E9-64010A954E23}", nodeBrowseOptions.Id);
            tree.AddSubMenuItem("Lock / Unlock Selected", "{77C30EB5-B3CC-4136-8372-656325BEBE14}", nodeBrowseOptions.Id);
            tree.AddSubMenuItem("Bold / Unbold Selected", "{DF418258-1559-4D05-A1E3-BB42075DE991}", nodeBrowseOptions.Id);
