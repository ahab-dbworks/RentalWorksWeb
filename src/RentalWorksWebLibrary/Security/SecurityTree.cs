    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuBillingReports         = AddReportsMenu("Billing Reports",                       "{DEEA3261-CE48-45A0-B797-5A0E3BB796BF}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       ...
                                                       AddReportsModule("Vendor Invoice Summary",       "{ABAA791E-72C0-4F27-A3C1-62894B58E9F7}", lv2menuBillingReports.Id,         "RwVendorInvoiceSummaryReportController",       "module/vendorinvoicesummaryreport",      reportsiconbaseurl + "placeholder.png", "Vendor Invoice Summary", "", "", description: "List all Invoices for a specific date range, subtotalled by Purchase Order and Deal.");
