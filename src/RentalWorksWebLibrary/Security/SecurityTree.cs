    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuBillingReports         = AddReportsMenu("Billing Reports",                       "{DEEA3261-CE48-45A0-B797-5A0E3BB796BF}", lv1menuReports.Id);
                                                       ...
                                                       AddReportsModule("Profit and Loss",              "{C5031AD1-EA1C-465E-9D83-211DACFFC707}", lv2menuBillingReports.Id,         "ProfitLossReportController",                   description: "");
                                                       ...
                                                       AddReportsModule("Sales Quote Billing Analysis", "{068866DB-C724-4CE4-B21D-7CBC72663756}", lv2menuBillingReports.Id,         "SalesQuoteBillingReportController",            description: "");
