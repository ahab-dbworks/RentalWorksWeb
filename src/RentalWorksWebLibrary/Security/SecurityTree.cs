    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuSetSettings          = AddSettingsMenu("Set Settings",                         "{210AB6DE-159D-4979-B321-3BC1EA6574D7}", lv1menuSettings.Id);
                                                     ...
                                                     AddSettingsModule("Ship Via",                    "{F9E01296-D240-4E16-B267-898787B29509}", lv1menuSettings.Id,             "ShipViaController",                     description: "");
                                                     AddSettingsModule("Source",                      "{6D6165D1-51F2-4616-A67C-DCC803B549AF}", lv1menuSettings.Id,             "SourceController",                      description: "");
            ...
            var lv2menuVehicleSettings      = AddSettingsMenu("Vehicle Settings",                     "{6081E168-E3BF-439E-82B0-34AF3680C444}", lv1menuSettings.Id);
                                                     ...
                                                     AddSettingsModule("Vehicle Rating",              "{09913CDB-68FB-4F18-BBAA-DCA8A8F926E5}", lv2menuVehicleSettings.Id,      "VehicleRatingController",               description: "");
            ...
            var lv2menuAccountingReports      = AddReportsMenu("Accounting Reports",                    "{51A99056-CDB7-48C4-AD5D-FADE02B925B6}", lv1menuReports.Id);
                                                       AddReportsModule("A/R Aging",                    "{03497C4E-CFDE-4156-8DDC-8125B84CA96C}", lv2menuAccountingReports.Id,      "RwArAgingReportController",                    description: "List unpaid Invoices, and their corresponding aging totals.  Report is subtotalled by Deal and Customer.");
                                                       AddReportsModule("Daily Receipts",               "{374153E2-477C-49C7-87E6-C09616C558CF}", lv2menuAccountingReports.Id,      "RwDailyReceiptsReportController",              description: "List Daily Receipts.  Report is subtotalled by Deal and Customer.");
                                                       AddReportsModule("G/L Distribution",             "{2A62BAAE-AC2D-418E-9A04-E46EFB0CDE71}", lv2menuAccountingReports.Id,      "RwGLDistributionReportController",             description: "Summarize transaction totals by Account over a date range.");
            var lv2menuBillingReports         = AddReportsMenu("Billing Reports",                       "{DEEA3261-CE48-45A0-B797-5A0E3BB796BF}", lv1menuReports.Id);
                                                       AddReportsModule("Agent Billing",                "{EE6CA8A3-C29E-40AD-8C85-EB52842F28A5}", lv2menuBillingReports.Id,         "RwAgentBillingReportController",               description: "Shows Invoice Activity Totals, subtotalled by Agent.");
                                                       AddReportsModule("Billing Progress",             "{BBEB89E1-093F-4C7B-9827-2ACD63F6534A}", lv2menuBillingReports.Id,         "RwBillingProgressReportController",            description: "List all Orders and their percentage of total Billing, subtotalled by Customer and Deal.");
                                                       AddReportsModule("Create Invoice Process",       "{071E33E3-E091-484A-A7BD-962A638F4E86}", lv2menuBillingReports.Id,         "RwCreateInvoiceProcessReportController",       description: "List all Invoices and Exceptions based on a Creation Batch.");
                                                       AddReportsModule("Invoice Discount",             "{9C562281-F742-4261-8F68-420A3422AC68}", lv2menuBillingReports.Id,         "RwInvoiceDiscountReportController",            description: "List all Invoices which have a Discount.");
                                                       AddReportsModule("Invoice Summary",              "{3373DC7D-24F2-4091-9129-5A959D002AB0}", lv2menuBillingReports.Id,         "RwInvoiceSummaryReportController",             description: "List all Invoices for a specific date range, subtotalled by Customer and Deal.");
                                                       AddReportsModule("Invoice Report",               "{B883BFB3-45E2-487A-9195-F7C8BB3B9535}", lv2menuBillingReports.Id,         "RwInvoiceReportController",                    description: "Print Invoice.");
                                                       AddReportsModule("Project Manager Billing",      "{E9652DDF-E325-485D-901C-EDAE30409FDB}", lv2menuBillingReports.Id,         "RwProjectManagerBillingReportController",      description: "Shows Invoice Activity Totals, subtotalled by Project Manager.");
                                                       AddReportsModule("Sales Representative Billing", "{BF9FED34-7896-4A53-A3C8-EC5E8A7D13A3}", lv2menuBillingReports.Id,         "RwSalesRepresentativeBillingReportController", description: "Shows Invoice Activity Totals, subtotalled by Sales Representative.");
            ...
            var lv2menuChargeProcessingReports = AddReportsMenu("Charge Processing Reports",            "{D31A00DD-58C8-4B22-9017-269B20FF230B}", lv1menuReports.Id);
                                                       AddReportsModule("Deal Invoice Batch",           "{4BDF8843-CE8D-4B21-BAB3-404A3B227FF6}", lv2menuChargeProcessingReports.Id, "RwDealInvoiceBatchReportController",          description: "List all Invoices processed in a selected Batch.");
                                                       AddReportsModule("Receipt Batch",                "{D045C2C9-ABE6-4488-8A94-59257319ABC7}", lv2menuChargeProcessingReports.Id, "RwReceiptBatchReportController",              description: "List all Receipts processed in a selected Batch.");
                                                       AddReportsModule("Vendor Invoice Batch",         "{FF9E8B35-4150-4519-950F-BC92C14358F4}", lv2menuChargeProcessingReports.Id, "RwVendorInvoiceBatchReportController",        description: "List all Vendor Invoices processed in a selected Batch.");
            var lv2menuContractReports        = AddReportsMenu("Contract Reports",                      "{D537CAA9-6B77-492F-9052-6CCABAEEDBC5}", lv1menuReports.Id);
                                                       AddReportsModule("Out Contract",                 "{46DFBBE2-B47B-4D91-A959-39A980DB5130}", lv2menuContractReports.Id,        "RwOutContractReportController",                description: "Check-Out Contract document.");
            var lv2menuCrewReports            = AddReportsMenu("Crew Reports",                          "{36F274CF-777F-45E3-B5D1-623E6D0E0963}", lv1menuReports.Id);
                                                       AddReportsModule("Crew Sign-In",                 "{4D3886A6-18AD-4CE5-9ECC-FB9EC8E104F3}", lv2menuCrewReports.Id,            "RwCrewSignInReportController",                 description: "Lists the Sign In and Out activity for Crew members over a specific date range.");
            var lv2menuDealReports            = AddReportsMenu("Deal Reports",                          "{B14EC8FA-15B6-470C-B871-FB83E7C24CB2}", lv1menuReports.Id);
                                                       AddReportsModule("Credits On Account",           "{F6578383-C27F-4842-871F-673807A7C375}", lv2menuDealReports.Id,            "RwCreditsOnAccountReportController",           description: "List each Deal that has an outstanding Credit Memo, Depleting Deposit, or Overpayment.");
                                                       AddReportsModule("Customer Revenue By Type",     "{7B328DAF-B45B-4D87-964C-37C2C17A42CD}", lv2menuDealReports.Id,            "RwCustomerRevenueByTypeReportController",      description: "List each Invoice for a specific date range.  Revenue amounts are broken down by Activity Type (ie. Rentals, Sales, etc).  Revenue is subtotalled by Customer and Deal.");
                                                       AddReportsModule("Deal Outstanding Items",       "{007F72D4-8767-472D-9706-8CDE8C8A9981}", lv2menuDealReports.Id,            "RwDealOutstandingItemsReportController",       description: "List all items still Checked-Out to a specific Deal.");
            var lv2menuOrderReports           = AddReportsMenu("Order Reports",                         "{17D093EB-4EF0-4391-8DDA-5108D3B16CEB}", lv1menuReports.Id);
                                                       AddReportsModule("Late Return / Due Back",       "{7349F6BE-08EE-4202-A571-2A5DEEDB6982}", lv2menuOrderReports.Id,           "RwLateReturnDueBackReportController",          description: "List all items that are Late or Due Back on a specific date.  Data is subtotalled by Order and Deal.");
                                                       AddReportsModule("Pick List",                    "{37A26BC9-9509-4524-9368-3D1E575142BD}", lv2menuOrderReports.Id,           "RwPickListReportController",                   description: "Pick List document.");
                                                       AddReportsModule("Print Order",                  "{8A0B608D-6C48-4403-AAF0-937FAF33AC46}", lv2menuOrderReports.Id,           "RwOrderReportController",                      description: "Print Order.");
                                                       AddReportsModule("Print Quote",                  "{F6C228BB-ECA0-4850-A620-E32F6406D782}", lv2menuOrderReports.Id,           "RwQuoteReportController",                      description: "Print Quote.");
            var lv2menuPartsInventoryReports  = AddReportsMenu("Parts Inventory Reports",               "{64C92B2E-CDEA-4D02-97E2-237052A1371C}", lv1menuReports.Id);
                                                       AddReportsModule("Parts Inventory Attributes",   "{2599963F-6676-4B5F-9850-864DB31C9427}", lv2menuPartsInventoryReports.Id,  "RwPartsInventoryAttributesReportController",   description: "List all Parts Inventory with their Attributes and Values.");
                                                       AddReportsModule("Parts Inventory Purchase History", "{7EC005CB-C3AE-4CF3-892A-78C6591449BE}", lv2menuPartsInventoryReports.Id, "RwPartsInventoryPurchaseHistoryReportController", description: "List all Parts Inventory Purchase History.");
                                                       AddReportsModule("Parts Inventory Reorder",      "{F1EC6BAE-4DBF-4B1D-9B91-CAC42E094C34}", lv2menuPartsInventoryReports.Id,  "RwPartsInventoryReorderReportController",      description: "List all Parts Inventory to reorder. Filter items with quantity levels at or below their Reorder Point.");
                                                       AddReportsModule("Parts Inventory Transactions", "{D2D997C9-ACCE-4F20-A192-9A8B8E232278}", lv2menuPartsInventoryReports.Id,  "RwPartsInventoryTransactionReportController",  description: "List all Parts Inventory Transactions, including Cost and Price, over a specific date range.");
            var lv2menuRentalInventoryReports = AddReportsMenu("Rental Inventory Reports",              "{36E1319D-928A-47A5-8CDE-69EF2085D742}", lv1menuReports.Id);
                                                       AddReportsModule("Rental Inventory Attributes",  "{291E443F-66F5-4ACB-9811-1580E0F57900}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryAttributesReportController",  description: "List all Rental Inventory with their Attributes and Values.");
                                                       AddReportsModule("Rental Inventory Catalog",     "{8840DE50-936E-4168-B061-A6092857A979}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryCatalogReportController",     description: "List all Rental Inventory, current Rates, Replacement Cost, and Owned Quantity.");
                                                       AddReportsModule("Rental Inventory Change",      "{0F628643-1F4E-447B-9CC9-8046C858EF19}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryChangeReportController",      description: "List all Rental Inventory changes.");
                                                       AddReportsModule("Rental Inventory Purchase History", "{883EFC41-E0AF-42CE-8C62-9387FCA19726}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryPurchaseHistoryReportController", description: "List all Rental Inventory Purchase History.");
                                                       AddReportsModule("Rental Inventory Value",       "{C01E92F1-8575-4C44-AC25-81F38B1EE1E0}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryValueReportController",       description: "List all Rental Inventory and get a current value, historical value, or change in value over a date range.");
                                                       AddReportsModule("Rental Inventory Usage",       "{E773F3DF-0B69-446E-930E-8090E328C686}", lv2menuRentalInventoryReports.Id, "RentalInventoryUsageReportController",         description: "List all Rental Inventory and Usage");
                                                       AddReportsModule("Rental Lost And Damaged Billing History", "{50CA126F-7DCF-4BE8-B95A-D78DE471A87E}", lv2menuRentalInventoryReports.Id, "RwRentalLostAndDamagedBillingHistoryReportController", description: "");
                                                       AddReportsModule("Retired Rental Inventory",     "{E85E3E91-6DEF-4A4B-ACA3-21E3F7154101}", lv2menuRentalInventoryReports.Id, "RwRetiredRentalInventoryReportController",     description: "List all Rental Inventory Retired during a specified date range.");
                                                       AddReportsModule("Return On Asset",              "{E80BD3B2-A855-4931-8195-419B5E531157}", lv2menuRentalInventoryReports.Id, "RwReturnOnAssetReportController",              description: "Calculate the Revenue, Value, Utilization, and Return on Asset for all Rental Inventory for various date ranges.");
                                                       AddReportsModule("Returned To Inventory",         "{A35F5A40-88BC-4009-9231-630D01B37CE8}", lv2menuRentalInventoryReports.Id, "RwReturnedToInventoryReportController",       description: "List all Rental Inventory Returned during a specified date range.");
                                                       AddReportsModule("Unretired Rental Inventory",   "{AA8B5A75-16DF-4741-88AC-30DD438831D3}", lv2menuRentalInventoryReports.Id, "RwUnretiredRentalInventoryReportController",   description: "List all Rental Inventory unretired during a specified date range.");
                                                       AddReportsModule("Value Of Out Rental Inventory", "{468ED977-EF42-4D04-BA2F-41CD1FF28C40}", lv2menuRentalInventoryReports.Id, "RwValueOfOutRentalInventoryReportController", description: "List all Rental Inventory Out on a specific date, including Cost and Value for each.");
            var lv2menuSalesInventoryReports  = AddReportsMenu("Sales Inventory Reports",               "{63978CEE-0A14-4926-AB15-88378B2F3A7A}", lv1menuReports.Id);
                                                       AddReportsModule("Sales Inventory Attributes",   "{FAF802B8-0C63-47DF-91A1-B3E157714E3B}", lv2menuSalesInventoryReports.Id, "RwSalesInventoryAttributesReportController", description: "List all Sales Inventory with their Attributes and Values.");
                                                       AddReportsModule("Sales Inventory Master", "{E0923F19-3D18-4B20-A31D-DE6C7694BC28}", lv2menuSalesInventoryReports.Id, "RwSalesInventoryMasterReportController", description: "");
                                                       AddReportsModule("Sales Inventory Purchase History", "{B50E2E87-0BE2-4B5A-B3AA-6985424657AE}", lv2menuSalesInventoryReports.Id, "RwSalesInventoryPurchaseHistoryReportController", description: "List all Sales Inventory Purchase History.");
                                                       AddReportsModule("Sales Inventory Reorder",      "{7F0AF306-CA9A-489C-9F91-86AEF0FC75EB}", lv2menuSalesInventoryReports.Id,  "RwSalesInventoryReorderReportController",      description: "List all Sales Inventory to reorder. Filter items with quantity levels at or below their Reorder Point.");
                                                       AddReportsModule("Sales Inventory Transactions", "{DEC28EAB-7D64-4A8C-ACBB-CB72706B818F}", lv2menuSalesInventoryReports.Id,  "RwSalesInventoryTransactionReportController",  description: "List all Sales Inventory Transactions, including Cost and Price, over a specific date range.");
        ...
        private void BuildTrakitWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuContractReports        = AddReportsMenu("Contract Reports",                  "{B59499EC-C399-464D-8E7B-3FC9D609917C}", lv1menuReports.Id);
                                                  AddReportsModule("Out Contract",                      "{F096F311-AB1D-4F99-BF2E-28E162B4C589}", lv2menuContractReports.Id,        "RwOutContractReportController",                    description: "Check-Out Contract document.");
            var lv2menuJobReports             = AddReportsMenu("Job Reports",                      "{018C2F78-0B86-446A-8ABC-8E0D9005C7D8}", lv1menuReports.Id);
                                                  AddReportsModule("Job Outstanding Items",            "{64F06943-8DC7-40B1-8EFE-8CE7FE8837DB}", lv2menuJobReports.Id,            "RwDealOutstandingItemsReportController",           description: "List all items still Checked-Out to a specific Job.");
            var lv2menuOrderReports           = AddReportsMenu("Order Reports",                     "{B8890ECF-7373-4CEC-97F2-BC1F3BDFDBCF}", lv1menuReports.Id);
                                                  AddReportsModule("Late Return / Due Back",            "{6AF06E65-7F20-453C-9DB2-E1B3EC87E93A}", lv2menuOrderReports.Id,           "RwLateReturnDueBackReportController",              description: "List all items that are Late or Due Back on a specific date.  Data is subtotalled by Order and Job.");
                                                  AddReportsModule("Pick List",                         "{89886648-AFD2-4D54-85F4-736D6C9F1FDC}", lv2menuOrderReports.Id,           "RwPickListReportController",                       description: "Pick List document.");
                                                  AddReportsModule("Print Order",                       "{C564316B-CCF1-4A1B-8136-522EE60AA34B}", lv2menuOrderReports.Id,           "RwOrderReportController",                          description: "Print Order.");
                                                  AddReportsModule("Print Request",                     "{BA8C6E26-C377-48F5-AD11-6EC6F59BCF63}", lv2menuOrderReports.Id,           "RwQuoteReportController",                          description: "Print Request.");
            var lv2menuRentalInventoryReports = AddReportsMenu("Rental Inventory Reports",          "{D558F2EF-6D99-4E06-8823-54FB462B92B3}", lv1menuReports.Id);
                                                  AddReportsModule("Rental Inventory Attributes",       "{660DF4D8-A8EB-4E34-9CAE-FAC34C44F8E0}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryAttributesReportController",      description: "List all Rental Inventory with their Attributes and Values.");
                                                  AddReportsModule("Rental Inventory Catalog",          "{2805C340-3DDE-4156-8A81-8CB0356A78C1}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryCatalogReportController",         description: "List all Rental Inventory, current Rates, Replacement Cost, and Owned Quantity.");
                                                  AddReportsModule("Rental Inventory Change",           "{7EE36577-798B-404B-9A18-38EC3E284FEA}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryChangeReportController",          description: "List all Rental Inventory changes.");
                                                  AddReportsModule("Rental Inventory Purchase History", "{C6409505-228B-4B3F-83B4-F98152BE32D5}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryPurchaseHistoryReportController", description: "List all Rental Inventory Purchase History.");
                                                  AddReportsModule("Rental Inventory Value",            "{F970DA66-7CC9-4977-86AF-A8BD4C6E0E7F}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryValueReportController",           description: "List all Rental Inventory and get a current value, historical value, or change in value over a date range.");
                                                  AddReportsModule("Retired Rental Inventory",          "{C12DA77E-ECE9-467B-91AF-48CDA7B5EDB1}", lv2menuRentalInventoryReports.Id, "RwRetiredRentalInventoryReportController",         description: "List all Rental Inventory Retired during a specified date range.");
                                                  AddReportsModule("Unretired Rental Inventory",        "{2FB76545-1869-4CFB-8F30-C05AB390D45B}", lv2menuRentalInventoryReports.Id, "RwUnretiredRentalInventoryReportController",       description: "List all Rental Inventory unretired during a specified date range.");
