    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuOrderReports           = AddReportsMenu("Order Reports",                         "{17D093EB-4EF0-4391-8DDA-5108D3B16CEB}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       AddReportsModule("Pick List",                    "{37A26BC9-9509-4524-9368-3D1E575142BD}", lv2menuOrderReports.Id,           "RwPickListReportController",                   "module/picklistreport",                  reportsiconbaseurl + "placeholder.png", "Pick List", "", "");
            var lv2menuRentalInventoryReports = AddReportsMenu("Rental Inventory Reports",              "{36E1319D-928A-47A5-8CDE-69EF2085D742}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       AddReportsModule("Rental Inventory Catalog",     "{8840DE50-936E-4168-B061-A6092857A979}", lv2menuRentalInventoryReports.Id, "RwRentalInventoryCatalogController",           "module/rentalinventorycatalog",          reportsiconbaseurl + "placeholder.png", "Rental Inventory Catalog", "", "");
            var lv2menuSalesInventoryReports  = AddReportsMenu("Sales Inventory Reports",               "{63978CEE-0A14-4926-AB15-88378B2F3A7A}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       AddReportsModule("Sales Inventory Transactions", "{DEC28EAB-7D64-4A8C-ACBB-CB72706B818F}", lv2menuSalesInventoryReports.Id,  "RwSalesInventoryTransactionsReportController", "module/salesinventorytransactionreport", reportsiconbaseurl + "placeholder.png", "Sales Inventory Transactions", "", "");
        ...
        private void BuildTrakItWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            //AddModule("Contact",          "{3F803517-618A-41C0-9F0B-2C96B8BDAFC4}", lv1menuModules.Id, "ContactController",         "module/contact",         homeiconbaseurl + "placeholder.png");
            //AddModule("Create Pick List", "{5013C4FF-FC42-4EFE-AE9D-AAF6857F17B8}", null,                  "CreatePickListController",  "module/createpicklist",  homeiconbaseurl + "placeholder.png");
            ...
            //AddModule("Pick List",        "{7B04E5D4-D079-4F3A-9CB0-844F293569ED}", lv1menuModules.Id, "PickListController",        "module/picklist",        homeiconbaseurl + "placeholder.png");
            //AddModule("Quote",            "{4D785844-BE8A-4C00-B1FA-2AA5B05183E5}", lv1menuModules.Id, "QuoteController",           "module/quote",           homeiconbaseurl + "placeholder.png");
            ...
            //AddModule("Vendor",           "{AE4884F4-CB21-4D10-A0B5-306BD0883F19}", lv1menuModules.Id, "VendorController",          "module/vendor",          homeiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("G/L Distribution",            "{7C249F59-B5E3-4DAE-933D-38D30858CF7C}", lv2menuAccountingSettings.Id,   "GlDistributionController",            "module/gldistribution",            settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("Country",                     "{D6E787E6-502B-4D36-B0A6-FA691E6D10CF}", lv2menuAddressSettings.Id,      "CountryController",                   "module/country",                   settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("State/Province",              "{B70B4B88-51EB-4635-971B-1F676243B810}", lv2menuAddressSettings.Id,      "StateController",                     "module/state",                     settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("Contact Event",               "{25ad258e-db9d-4e94-a500-0382e7a2024a}", lv2menuContactSettings.Id,      "ContactEventController",              "module/contactevent",              settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Contact Title",               "{1b9183b2-add9-416d-a5e1-59fe68104e4a}", lv2menuContactSettings.Id,      "ContactTitleController",              "module/contacttitle",              settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Mail List",                   "{255ceb68-fb87-4248-ab99-37c18a192300}", lv2menuContactSettings.Id,      "MailListController",                  "module/maillist",                  settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("Credit Status",               "{A28D0CC9-B922-4259-BA4A-A5DE474ADFA4}", lv2menuCustomerSettings.Id,     "CreditStatusController",              "module/creditstatus",              settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Customer Category",           "{8FB6C746-AB6E-4CA5-9BD4-4E9AD88A3BC5}", lv2menuCustomerSettings.Id,     "CustomerCategoryController",          "module/customercategory",          settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Customer Status",             "{B689A0AA-9FCC-450B-AF0F-AD85483531FA}", lv2menuCustomerSettings.Id,     "CustomerStatusController",            "module/customerstatus",            settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Customer Type",               "{314EDC6F-478A-40E2-B17E-349886A85EA0}", lv2menuCustomerSettings.Id,     "CustomerTypeController",              "module/customertype",              settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("Building",                    "{2D344845-7E77-40C9-BB9D-04A930D352EB}", lv2menuFacilitiesSettings.Id,   "BuildingController",                  "module/building",                  settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("Market Segment",              "{53B627BE-6AC8-4C1F-BEF4-E8B0A5422E14}", lv2menuOrderSettings.Id,        "MarketSegmentController",             "module/marketsegment",             settingsiconbaseurl + "placeholder.png");
            //                                         AddModule("Market Type",                 "{77D7FD11-EBD2-40A2-A40D-C82D32528A01}", lv2menuOrderSettings.Id,        "MarketTypeController",                "module/markettype",                settingsiconbaseurl + "placeholder.png");
            ...
            //                                         AddModule("PO Type",                     "{BB8D68B3-012A-4B05-BE7F-844EB5C96896}", lv2menuPOSettings.Id,           "POTypeController",                    "module/potype",                    settingsiconbaseurl + "placeholder.png");
            ...
            //                                           AddModule("Credits On Account",           "{F6578383-C27F-4842-871F-673807A7C375}", lv2menuDealReports.Id,            "RwCreditsOnAccountController",                 "module/creditsonaccount",                reportsiconbaseurl + "placeholder.png", "Credits on Account", "", "");
            ...
            //var lv2menuRentalInventoryReports = AddLv2ModuleMenu("Rental Inventory Reports",     "{36E1319D-928A-47A5-8CDE-69EF2085D742}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png", "Rental Inventory Reports");
