    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuRentalInventoryReports = AddReportsMenu("Rental Inventory Reports",              "{36E1319D-928A-47A5-8CDE-69EF2085D742}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       ...
                                                       AddReportsModule("Value Of Out Rental Inventory", "{468ED977-EF42-4D04-BA2F-41CD1FF28C40}", lv2menuRentalInventoryReports.Id, "RwValueOfOutRentalInventoryReportController", "module/valueofoutrentalinventoryreport", reportsiconbaseurl + "placeholder.png", "ValueOfOutRentalInventoryReport", "", "", description: "");
