    ...
    public class SecurityTree : FwSecurityTree
    {
        ...
        private void BuildRentalWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            var lv2menuAccountingReports      = AddReportsMenu("Accounting Reports",                    "{51A99056-CDB7-48C4-AD5D-FADE02B925B6}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       ...
                                                       AddReportsModule("Daily Receipts",               "{374153E2-477C-49C7-87E6-C09616C558CF}", lv2menuAccountingReports.Id,      "RwDailyReceiptsReportController",              "module/dailyreceiptsreport",             reportsiconbaseurl + "placeholder.png", "Daily Receipts", description: "List Daily Receipts.  Report is subtotalled by Deal and Customer.");
            ...
            var lv2menuChargeProcessingReports = AddReportsMenu("Charge Processing Reports",            "{D31A00DD-58C8-4B22-9017-269B20FF230B}", lv1menuReports.Id, reportsiconbaseurl + "placeholder.png");
                                                       AddReportsModule("Deal Invoice Batch",           "{4BDF8843-CE8D-4B21-BAB3-404A3B227FF6}", lv2menuChargeProcessingReports.Id, "RwDealInvoiceBatchReportController",          "module/dealinvoicebatchreport",          reportsiconbaseurl + "placeholder.png", description: "List all Invoices processed in a selected Batch.");
                                                       AddReportsModule("Receipt Batch",                "{D045C2C9-ABE6-4488-8A94-59257319ABC7}", lv2menuChargeProcessingReports.Id, "RwReceiptBatchReportController",              "module/receiptbatchreport",              reportsiconbaseurl + "placeholder.png", description: "List all Receipts processed in a selected Batch.");
                                                       AddReportsModule("Vendor Invoice Batch",         "{FF9E8B35-4150-4519-950F-BC92C14358F4}", lv2menuChargeProcessingReports.Id, "RwVendorInvoiceBatchReportController",        "module/vendorinvoicebatchreport",        reportsiconbaseurl + "placeholder.png", description: "List all Vendor Invoices processed in a selected Batch.");
            ...
            var lv2menuRentalInventoryReports = AddReportsMenu("Rental Inventory Reports",              "{36E1319D-928A-47A5-8CDE-69EF2085D742}", lv1menuReports.Id,                                                                                                          reportsiconbaseurl + "placeholder.png");
                                                       ...
                                                       AddReportsModule("Returned To Inventory",         "{A35F5A40-88BC-4009-9231-630D01B37CE8}", lv2menuRentalInventoryReports.Id, "RwReturnedToInventoryReportController",        "module/returnedtoinventoryreport",       reportsiconbaseurl + "placeholder.png", "Returned To Inventory", "", "", description: "List all Rental Inventory Returned during a specified date range.");
                                                       ...
                                                       AddReportsModule("Value Of Out Rental Inventory Report", "{468ED977-EF42-4D04-BA2F-41CD1FF28C40}", lv2menuRentalInventoryReports.Id, "RwValueOfOutRentalInventoryReportController", "module/valueofoutrentalinventoryreport", reportsiconbaseurl + "placeholder.png", "ValueOfOutRentalInventoryReport", "", "", description: "");
            ...
            var lv2menuVendorReports =         AddReportsMenu("Vendor Reports",                        "{27E99ADD-6DF1-4DB1-A54F-D7BFA6767C30}", lv1menuReports.Id, reportsiconbaseurl + "placeholder.png");
                                                       AddReportsModule("Vendor Invoice Summary",       "{ABAA791E-72C0-4F27-A3C1-62894B58E9F7}", lv2menuVendorReports.Id,         "RwVendorInvoiceSummaryReportController",       "module/vendorinvoicesummaryreport",      reportsiconbaseurl + "placeholder.png", "Vendor Invoice Summary", "", "", description: "List all Invoices for a specific date range, subtotalled by Purchase Order and Deal.");
            ...
            AddModule("QuikActivity Calendar",         "{897BCF55-6CE7-412C-82CB-557B045F8C0A}", lv1menuUtilities.Id, "QuikActivityCalendarController",         "module/quikactivitycalendar",      utilitiesiconbaseurl + "placeholder.png", "", "", "");
        ...
        private void BuildTrakitWorksWebTree(FwSecurityTreeNode system)
        {
            ...
            AddModule("Request",                "{9213AF53-6829-4276-9DF9-9DAA704C2CCF}", lv1menuModules.Id, "QuoteController",             "module/quote",             homeiconbaseurl + "placeholder.png");
