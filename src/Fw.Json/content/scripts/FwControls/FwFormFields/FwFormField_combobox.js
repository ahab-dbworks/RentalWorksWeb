FwFormField_combobox = {};
//---------------------------------------------------------------------------------
FwFormField_combobox.renderDesignerHtml = function($control, html) {
    ...
    html.push('<div class="fwformfield-control">');
        ...
        html.push(' />');
        html.push('<img class="btnvalidate" src="' + applicationConfig.appbaseurl + applicationConfig.appvirtualdirectory + 'theme/fwimages/icons/128/dropdownarrow.001.png" />');
    html.push('</div>');
    $control.html(html.join(''));
};
//---------------------------------------------------------------------------------
FwFormField_combobox.renderRuntimeHtml = function($control, html) {
    ...
    html.push('<div class="fwformfield-control">');
        ...
        if (isdesktop) {
            ...
            html.push('<i class="material-icons md-dark btnvalidate">expand_more</i>');
        }
    html.push('</div>');
    $control.html(html.join(''));
...
//---------------------------------------------------------------------------------
FwFormField_combobox.loadItems = function($control, items, hideEmptyItem) {

};
//---------------------------------------------------------------------------------
FwFormField_combobox.loadForm = function($fwformfield, table, field, value, text) {
    $fwformfield
...
//---------------------------------------------------------------------------------
FwFormField_combobox.disable = function($control) {
    $control.find('.btnvalidate').attr('data-enabled', 'false');
    $control.find('.fwformfield-text').prop('disabled', true);
};
//---------------------------------------------------------------------------------
FwFormField_combobox.enable = function($control) {
    $control.find('.btnvalidate').attr('data-enabled', 'true');
    $control.find('.fwformfield-text').prop('disabled', false);
};
//---------------------------------------------------------------------------------
FwFormField_combobox.getValue2 = function($fwformfield) {
    var value = $fwformfield.find('.fwformfield-value').val();
    return value;
};
//---------------------------------------------------------------------------------
FwFormField_combobox.getText2 = function($fwformfield) {
    var text = $fwformfield.find('.fwformfield-text').val();
    return text;
};
//---------------------------------------------------------------------------------
FwFormField_combobox.setValue = function($fwformfield, value, text, firechangeevent) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.initControl = function($control) {
    ...
    //$validationbrowse.attr('data-pagesize', '2');
...
//---------------------------------------------------------------------------------
FwFormField_combobox.databindcallback = function($control, $browse, dt, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, controller) {
            ...
            htmlPager.push('<div class="pager dropdownpager">');
                if (isdesktop) {
                    if ((pageSize > 0) && (dt.PageNo > 1)) {
                        htmlPager.push('<div tabindex="0" class="pagerbutton btnFirstPage" data-enabled="true" title="First" alt="First"><div class="firsticon"></div></div>');
                        htmlPager.push('<div tabindex="0" class="pagerbutton btnPreviousPage" data-enabled="true" title="Previous" alt="Previous"><div class="previousicon"></div></div>');
                    } else {
                        htmlPager.push('<div class="pagerbutton btnFirstPage" disabled="disabled" data-enabled="false" title="First" alt="First"><div class="firsticon"></div></div>');
                        htmlPager.push('<div class="pagerbutton btnPreviousPage" disabled="disabled" data-enabled="false" title="Previous" alt="Previous"><div class="previousicon"></div></div>');
                    }
                    ...
                    if ((pageSize > 0) &&(dt.TotalPages > 1) && (dt.PageNo < dt.TotalPages)) {
                        htmlPager.push('<div class="pagerbutton btnNextPage" data-enabled="true" title="Next" alt="Next"><div class="nexticon"></div></div>');
                        htmlPager.push('<div class="pagerbutton btnLastPage" data-enabled="true" title="Last" alt="Last"><div class="lasticon"></div></div>');
                    } else {
                        htmlPager.push('<div class="pagerbutton btnNextPage" disabled="disabled" data-enabled="false" title="Next" alt="Next"><div class="nexticon"></div></div>');
                        htmlPager.push('<div class="pagerbutton btnLastPage" disabled="disabled" data-enabled="false" title="Last" alt="Last"><div class="lasticon"></div></div>');
                    }
                } else if (ismobile) {
                    if ((pageSize > 0) && (dt.PageNo > 1)) {
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnFirstPage" data-enabled="true">first_page</i>');
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnPreviousPage" data-enabled="true">chevron_left</i>');
                    } else {
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnFirstPage" disabled="disabled" data-enabled="false">first_page</i>');
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnPreviousPage" disabled="disabled" data-enabled="false">chevron_left</i>');
                    }
                    htmlPager.push('<input class="txtPageNo" type="text" value="' + dt.PageNo + '"/>');
                    htmlPager.push('<span class="of"> of </span>');
                    htmlPager.push('<span class="txtTotalPages">' + dt.TotalPages + '</span>');
                    if ((pageSize > 0) &&(dt.TotalPages > 1) && (dt.PageNo < dt.TotalPages)) {
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnNextPage" data-enabled="true">chevron_right</i>');
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnLastPage" data-enabled="true">last_page</i>');
                    } else {
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnNextPage" disabled="disabled" data-enabled="false">chevron_right</i>');
                        htmlPager.push('<i class="material-icons md-dark pagerbutton btnLastPage" disabled="disabled" data-enabled="false">last_page</i>');
                    }
                }
            htmlPager.push('</div>');
        }
...
//---------------------------------------------------------------------------------
FwFormField_combobox.closeDropDown = function($control, showAnimation) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.validate = function($control, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, useSearchFieldValue) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.selectRow = function($control, $row, validationName, $valuefield, $searchfield, $btnvalidate, $validationbrowse, controller) {
    var uniqueid, text;
    
    FwFormField_combobox.highlightRow($row);

    // set the uniqueid
    uniqueid = $row.attr('data-uniqueid');
...
//---------------------------------------------------------------------------------
FwFormField_combobox.clearSearchCriteria = function($validationbrowse) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.getHighlightedRow = function($control) {
    var $row = null;
    if ($control.data('dropdown') !== null) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.highlightRow = function($control, $row) {
    if (($control.data('dropdown') !== null) && (typeof $row === 'object') && ($row.length > 0)) {
        $control.data('dropdown').find('.row').removeClass('selected');
        $row.addClass('selected');
    }
};
//---------------------------------------------------------------------------------
FwFormField_combobox.highlightNextRow = function($control) {
...
//---------------------------------------------------------------------------------
FwFormField_combobox.highlightPrevRow = function($control) {
    var $row = FwFormField_combobox.getHighlightedRow($control);
    if ($row !== null) {
