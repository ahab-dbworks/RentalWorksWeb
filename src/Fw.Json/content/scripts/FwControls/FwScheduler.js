...
var FwScheduler = {};
//---------------------------------------------------------------------------------
FwScheduler.renderRuntimeHtml = function($control) {
    var html, $daypilotcontrol, dp, nav, navcalendarid, dpcalendarid, navmonthid, dpmonthid, navschedulerid, dpschedulerid, viewCount, schedulerbtns, 
...
//---------------------------------------------------------------------------------
FwScheduler.init = function($control) {
...
//---------------------------------------------------------------------------------
FwScheduler.loadControl = function($control) {
...
//---------------------------------------------------------------------------------
FwScheduler.loadNavCalendar = function($control) {
    var navcalendar;
...
//---------------------------------------------------------------------------------
FwScheduler.loadNavMonth = function($control) {
    var navmonth;
...
//---------------------------------------------------------------------------------
FwScheduler.loadNavScheduler = function($control) {
    var navscheduler;
...
//---------------------------------------------------------------------------------
FwScheduler.loadCalendar = function($control) {
    var dpcalendar;
...
//---------------------------------------------------------------------------------
FwScheduler.loadMonth = function($control) {
    var dpmonth;
    ...
    dpmonth.onBeforeCellRender = function(args) {
        ...
        if (typeof selectedstartdate === 'object') {
...
//---------------------------------------------------------------------------------
FwScheduler.loadScheduler = function($control) {
    var dpscheduler;
...
//---------------------------------------------------------------------------------
FwScheduler.navigate = function($control, date) {
...
//---------------------------------------------------------------------------------
FwScheduler.showDayView = function($control) {
    ...
    if (typeof $control.data('selectedstartdate') === 'object') {
        selectedstartdate = $control.data('selectedstartdate');
        FwScheduler.navigate($control, selectedstartdate);
    }
};
//---------------------------------------------------------------------------------
FwScheduler.showWeekView = function($control) {
    var navcalendar, dpcalendar, selectedstartdate;
    navcalendar = $control.data('navcalendar');
...
//---------------------------------------------------------------------------------
FwScheduler.showMonthView = function($control) {
...
//---------------------------------------------------------------------------------
FwScheduler.showScheduleView = function($control) {
    var navcalendar, selectedstartdate;
    navcalendar = $control.data('navcalendar');
    navcalendar.selectMode = "month";
    navcalendar.update();
...
//---------------------------------------------------------------------------------
FwScheduler.refresh = function($control) {
    FwScheduler.loadEvents($control);
};
//---------------------------------------------------------------------------------
FwScheduler.loadEvents = function($control) {
...
//---------------------------------------------------------------------------------
FwScheduler.loadEventsCallback = function($control, resources, events) {
    var dpcalendar, dpmonth, dpscheduler, start, end, request;
    dpcalendar  = $control.data('dpcalendar');
    dpmonth     = $control.data('dpmonth');
    dpscheduler = $control.data('dpscheduler');
    
    if ((typeof dpcalendar === 'object') && (typeof dpmonth === 'object') && (typeof dpscheduler === 'object')) {
        switch ($control.find('div.changeview[data-selected="true"]').html()) {
            case 'Day':
...
//---------------------------------------------------------------------------------
FwScheduler.getSelectedTimeRange = function($control) {
    var result, dpmonth;
    result = {
...
//---------------------------------------------------------------------------------
FwScheduler.getSelectedDay = function($control) {
    var result;
    result = $control.data('selectedstartdate');
    return result;
};
//---------------------------------------------------------------------------------
FwScheduler.setSelectedTimeRange = function($control, start, end) {
...
//---------------------------------------------------------------------------------
FwScheduler.setSelectedDay = function($control, date) {
    var start, end;
...
//---------------------------------------------------------------------------------
FwScheduler.setDateCallout = function($control, date) {
...
FwScheduler.addEvent = function($control, evt) {
    var dpcalendar, dpmonth, dpscheduler, e, action;
    dpcalendar  = $control.data('dpcalendar');
    dpmonth     = $control.data('dpmonth');
    dpscheduler = $control.data('dpscheduler');
...
//---------------------------------------------------------------------------------
FwScheduler.addButtonMenuItem = function($control, classname, text, onclick) {
    var $menu, $menuitem;
...
//---------------------------------------------------------------------------------
FwScheduler.load = function($control) {
...
//---------------------------------------------------------------------------------
FwScheduler.getTodaysDate = function() {
