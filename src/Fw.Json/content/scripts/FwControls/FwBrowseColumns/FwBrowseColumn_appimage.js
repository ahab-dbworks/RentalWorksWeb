FwBrowseColumn_appimage = {};
//---------------------------------------------------------------------------------
FwBrowseColumn_appimage.databindfield = function($browse, $field, dt, dtRow, field, $tr) {
    var uniqueid1, uniqueid2, uniqueid3, hasimage;
    uniqueid1      = (typeof dtRow[dt.ColumnIndex[field.uniqueid1field]]  === 'string') ? dtRow[dt.ColumnIndex[field.uniqueid1field]] : '';
    uniqueid2      = (typeof dtRow[dt.ColumnIndex[field.uniqueid2field]]  === 'string') ? dtRow[dt.ColumnIndex[field.uniqueid2field]] : '';
    uniqueid3      = (typeof dtRow[dt.ColumnIndex[field.uniqueid3field]]  === 'string') ? dtRow[dt.ColumnIndex[field.uniqueid3field]] : '';
    hasimage       = (typeof dtRow[dt.ColumnIndex[field.browsedatafield]] === 'string') ? dtRow[dt.ColumnIndex[field.browsedatafield]] : '';
...
//---------------------------------------------------------------------------------
FwBrowseColumn_appimage.getFieldValue = function($browse, $tr, $field, field, originalvalue) {
...
//---------------------------------------------------------------------------------
FwBrowseColumn_appimage.setFieldEditMode = function($browse, $field, $tr, html) {
