...
//---------------------------------------------------------------------------------
FwBrowseColumn_appdocumentimage.databindfield = function($browse, $field, dt, dtRow, field, $tr) {
    if (typeof dt.ColumnIndex[field.browseappdocumentidfield] !== 'number') throw 'FwBrowseColumn_appdocumentimage.databindfield: ' + field.browseappdocumentidfield + ' was not returned by the webservice.';
    if (typeof dt.ColumnIndex[field.browsefilenamefield]      !== 'number') throw 'FwBrowseColumn_appdocumentimage.databindfield: ' + field.browsefilenamefield      + ' was not returned by the webservice.';
    if (typeof dt.ColumnIndex[field.browsefileextensionfield] !== 'number') throw 'FwBrowseColumn_appdocumentimage.databindfield: ' + field.browsefileextensionfield + ' was not returned by the webservice.';
    var appdocumentid  = dtRow[dt.ColumnIndex[field.browseappdocumentidfield]];
    var documenttypeid = dtRow[dt.ColumnIndex[field.documenttypeidfield]];
    var uniqueid1      = dtRow[dt.ColumnIndex[field.uniqueid1field]];
    var uniqueid2      = dtRow[dt.ColumnIndex[field.uniqueid2field]];
    var uniqueid3      = dtRow[dt.ColumnIndex[field.uniqueid3field]];
    var filename       = dtRow[dt.ColumnIndex[field.browsefilenamefield]];
    var fileextension  = dtRow[dt.ColumnIndex[field.browsefileextensionfield]];
    var miscfield      = dtRow[dt.ColumnIndex[field.miscfield]];
...
FwBrowseColumn_appdocumentimage.setFieldViewMode = function($browse, $field, $tr, html) {
    ...
    switch(fileextension) {
        case 'pdf':
            html.push('<div class="viewcell flexrow flexalignitemscenter">');
            ...
            html.push('  <div class="col2"><i class="material-icons" title="E-mail Document">email</i></div>');
            html.push('</div>');
            break;
                ...
                FwAppData.jsonPost(true, webserviceurl, requestGetFromEmail, FwServices.defaultTimeout, 
                    function(responseGetFromEmail) {
                        try {
                            ...
                            dlg.push('    </div>');
                            dlg.push('    <div class="fwcontrol fwcontainer fwform-fieldrow" data-control="FwContainer" data-type="fieldrow">');
                            dlg.push('      <div data-datafield="tousers" data-control="FwFormField" data-type="multiselectvalidation" class="fwcontrol fwformfield" data-caption="To (lookup)" data-validationname="WebUsersEmail" data-hasselectall="false" style="float:left;box-sizing:border-box;width:20%;"></div>');
                            ...
                            dlg.push('    </div>');
                            dlg.push('    <div class="fwcontrol fwcontainer fwform-fieldrow" data-control="FwContainer" data-type="fieldrow">');
                            dlg.push('      <div data-datafield="ccusers" data-control="FwFormField" data-type="multiselectvalidation" class="fwcontrol fwformfield" data-caption="CC (lookup)" data-validationname="WebUsersEmail"  data-hasselectall="false" style="float:left;box-sizing:border-box;width:20%;"></div>');
