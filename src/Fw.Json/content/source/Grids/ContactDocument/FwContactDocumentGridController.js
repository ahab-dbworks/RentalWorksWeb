//----------------------------------------------------------------------------------------------
var FwContactDocumentGridController = {
    Module: 'ContactDocument'
};
//----------------------------------------------------------------------------------------------
FwContactDocumentGridController.init = function($control) {
};
//----------------------------------------------------------------------------------------------
FwContactDocumentGridController.addGridSubMenu = function($control, $menu) {
