...
RwServices.order.checkInItemCancel                     = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/checkinitemcancel',                     request, doneCallback);};
RwServices.order.checkInItemSendToRepair               = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/checkinitemsendtorepair',               request, doneCallback);};
RwServices.order.checkInQty                            = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/checkinqty',                            request, doneCallback);};
RwServices.order.checkInAllQtyItems                    = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/checkinallqtyitems',                    request, doneCallback);};
...
RwServices.order.getCheckInPendingList                 = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/getcheckinpendinglist',                 request, doneCallback);};
RwServices.order.getCheckInSessionInList               = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/getcheckinsessioninlist',               request, doneCallback);};
RwServices.order.getItemStatus                         = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/getitemstatus',                         request, doneCallback);};
RwServices.order.itemstatusrfid                        = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/order/itemstatusrfid',                        request, doneCallback);};
...
RwServices.order.getRentalConditions                   = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/inventory/getrentalconditions',               request, doneCallback);};
RwServices.order.getRentalItemCondition                = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/inventory/getrentalitemcondition',            request, doneCallback);};
RwServices.order.getRepairOrder                        = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/inventory/getrentalitemcondition',            request, doneCallback);};
...
RwServices.order.updateRentalItemQC                    = function(request, doneCallback) {RwAppData.jsonPost(true,  'services.ashx?path=/inventory/updaterentalitemqc',                request, doneCallback);};
...
RwServices.call = function (servicename, methodname, request, doneCallback, async) {
    RwAppData.jsonPost(true, 'services.ashx?path=/services/' + servicename + '/' + methodname, request, doneCallback, null, async);
}
//----------------------------------------------------------------------------------------------
