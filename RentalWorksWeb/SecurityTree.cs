...
namespace RentalWorksWeb
{
    public class SecurityTree : FwApplicationTree
    {
        ...
        private void BuildRentalWorksQuikScanTree()
        {
            ...
            AddModule("Item Disposition",    "{1573C03C-5ADA-407C-8B7E-D2158920D1CC}", lv1menuHome.Id, "", "inventory/assetdisposition",      iconbaseurl + "assetdisposition.001.png", "",                 "production",    "USER");
