        ...
        public static void ModuleRouting(dynamic request, dynamic response, dynamic session)
        {
            ...
            switch(componentType)
            {
                case "Module":
                    ...
                    type = typeof(RwService).Assembly.GetType("RentalWorksWebLibrary.Modules.Rw" + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwModule))))
                    {
                        FwModule module = (FwModule)Activator.CreateInstance(type);
                        module.Init("RentalWorksWebLibrary", "Rw", typeof(RwService).Assembly, request, response, session);
                        if (module != null)
                        {
                ...
                case "Grid":
                    ...
                    type = typeof(RwService).Assembly.GetType("RentalWorksWebLibrary.Grids.Rw" + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwGrid))))
                    {
                        FwGrid grid = (FwGrid)Activator.CreateInstance(type);
                        grid.Init("RentalWorksWebLibrary", "Rw", typeof(RwService).Assembly, request, response, session);
                        if (grid != null)
                        {
                ...
                case "Validation":
                    ...
                    type = typeof(RwService).Assembly.GetType("RentalWorksWebLibrary.Validations.Rw" + name, false);
                    if ((type != null) && (type.IsSubclassOf(typeof(FwValidation))))
                    {
                        FwValidation validation = (FwValidation)Activator.CreateInstance(type);
                        validation.Init("RentalWorksWebLibrary", "Rw", typeof(RwService).Assembly, request, response, session);
                        if (validation != null)
                        {
                ...
                case "Reports":
                    ...
                    type = typeof(RwService).Assembly.GetType("RentalWorksWebLibrary.Reports.Rw" + name, false);
